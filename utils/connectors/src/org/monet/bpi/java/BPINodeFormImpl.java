...
public abstract class BPINodeFormImpl<Schema extends BPISchema,
	OperationEnum extends Enum<?>,
	Owner extends BPIBaseNode<?>>
	extends BPINodeImpl<Owner, Schema>
	implements BPINodeForm<Owner, Schema>, BPIBehaviorNodeForm<OperationEnum> {
