...
public class BPIExpression {
  
  public static final String AND = " AND ";
  public static final String OR = " OR ";
  
  private BPIExpression[] expressions = null;
  private String op;
  ...
  protected BPIExpression(String op, BPIExpression...args) {
  ...
  public HashMap<String, Object> getParameters(IndexGenerator idx) {
    ...
    for(BPIExpression expr : this.expressions) {
  ...
  private static BPIExpression build(String op, BPIExpression expr1, BPIExpression expr2, BPIExpression... exprN) {
    BPIExpression[] expressions = new BPIExpression[exprN.length+2];
    expressions[0] = expr1;
    expressions[1] = expr2;
    for(int i=2;i<expressions.length;i++)
      expressions[i] = exprN[i-2];
    return new BPIExpression(op, expressions);
  }
  
  public static BPIExpression And(BPIExpression expr1, BPIExpression expr2, BPIExpression... exprN) {
    return build(AND, expr1, expr2, exprN);
  }
  
  public static BPIExpression Or(BPIExpression expr1, BPIExpression expr2, BPIExpression... exprN) {
