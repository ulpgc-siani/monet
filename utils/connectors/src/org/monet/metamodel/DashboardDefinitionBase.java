...
}}protected SecondaryProperty _secondaryProperty;public SecondaryProperty getSecondary() { return _secondaryProperty; }public void setSecondary(SecondaryProperty value) { if(_secondaryProperty!=null) _secondaryProperty.merge(value); else {_secondaryProperty = value;} }public static class SecondaryLocationProperty  {protected org.monet.metamodel.internal.Ref _useX;public org.monet.metamodel.internal.Ref getUseX() { return _useX; }public void setUseX(org.monet.metamodel.internal.Ref value) { _useX = value; }protected org.monet.metamodel.internal.Ref _useY;public org.monet.metamodel.internal.Ref getUseY() { return _useY; }public void setUseY(org.monet.metamodel.internal.Ref value) { _useY = value; }protected org.monet.metamodel.internal.Ref _useAmount;public org.monet.metamodel.internal.Ref getUseAmount() { return _useAmount; }public void setUseAmount(org.monet.metamodel.internal.Ref value) { _useAmount = value; }public enum MarkerIconEnumeration { HUMAN,BICYCLE,CAR,BUS,TRUCK,WATER_VEHICLE,AIRPLANE,TRAIN,NONE }protected MarkerIconEnumeration _markerIcon;public MarkerIconEnumeration getMarkerIcon() { return _markerIcon; }public void setMarkerIcon(MarkerIconEnumeration value) { _markerIcon = value; }public static class CenterProperty  {protected Double _latitude;public Double getLatitude() { return _latitude; }public void setLatitude(Double value) { _latitude = value; }protected Double _longitude;public Double getLongitude() { return _longitude; }public void setLongitude(Double value) { _longitude = value; }protected Long _zoom;public Long getZoom() { return _zoom; }public void setZoom(Long value) { _zoom = value; }protected void copy(CenterProperty instance) {this._latitude = instance._latitude;
this._longitude = instance._longitude;
this._zoom = instance._zoom;
}protected void merge(CenterProperty child) {if(child._latitude != null)this._latitude = child._latitude;
if(child._longitude != null)this._longitude = child._longitude;
if(child._zoom != null)this._zoom = child._zoom;
}}protected CenterProperty _centerProperty;public CenterProperty getCenter() { return _centerProperty; }public void setCenter(CenterProperty value) { if(_centerProperty!=null) _centerProperty.merge(value); else {_centerProperty = value;} }protected void copy(SecondaryLocationProperty instance) {this._useX = instance._useX;
this._useY = instance._useY;
this._useAmount = instance._useAmount;
this._markerIcon = instance._markerIcon;
this._centerProperty = instance._centerProperty; 
}protected void merge(SecondaryLocationProperty child) {if(child._useX != null)this._useX = child._useX;
if(child._useY != null)this._useY = child._useY;
if(child._useAmount != null)this._useAmount = child._useAmount;
if(child._markerIcon != null)this._markerIcon = child._markerIcon;
if(_centerProperty == null) _centerProperty = child._centerProperty; else if (child._centerProperty != null) {_centerProperty.merge(child._centerProperty);}
}}protected SecondaryLocationProperty _secondaryLocationProperty;public SecondaryLocationProperty getSecondaryLocation() { return _secondaryLocationProperty; }public void setSecondaryLocation(SecondaryLocationProperty value) { if(_secondaryLocationProperty!=null) _secondaryLocationProperty.merge(value); else {_secondaryLocationProperty = value;} }protected void copy(LevelProperty instance) {this._primaryProperty = instance._primaryProperty; 
this._secondaryProperty = instance._secondaryProperty; 
this._secondaryLocationProperty = instance._secondaryLocationProperty; 
...
if(_secondaryLocationProperty == null) _secondaryLocationProperty = child._secondaryLocationProperty; else if (child._secondaryLocationProperty != null) {_secondaryLocationProperty.merge(child._secondaryLocationProperty);}
}}protected LevelProperty _levelProperty;public LevelProperty getLevel() { return _levelProperty; }public void setLevel(LevelProperty value) { if(_levelProperty!=null) _levelProperty.merge(value); else {_levelProperty = value;} }public static class FilterProperty  {public enum ResolutionEnumeration { YEARS,MONTHS,DAYS,HOURS,MINUTES,SECONDS }protected ArrayList<ResolutionEnumeration> _resolution = new ArrayList<ResolutionEnumeration>();public ArrayList<ResolutionEnumeration> getResolution() { return _resolution; }public void setResolution(ArrayList<ResolutionEnumeration> value) { _resolution = value; }protected void copy(FilterProperty instance) {this._resolution.addAll(instance._resolution);
}protected void merge(FilterProperty child) {if(child._resolution != null)this._resolution.addAll(child._resolution);
}}protected FilterProperty _filterProperty;public FilterProperty getFilter() { return _filterProperty; }public void setFilter(FilterProperty value) { if(_filterProperty!=null) _filterProperty.merge(value); else {_filterProperty = value;} }protected void copy(IndicatorProperty instance) {this._label = instance._label;
