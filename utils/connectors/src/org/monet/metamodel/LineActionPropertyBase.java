...
}}protected TimeoutProperty _timeoutProperty;public TimeoutProperty getTimeout() { return _timeoutProperty; }public void setTimeout(TimeoutProperty value) { if(_timeoutProperty!=null) _timeoutProperty.merge(value); else {_timeoutProperty = value;} }public static class LineStopProperty extends ReferenceableProperty {protected Object _label;public Object getLabel() { return _label; }public void setLabel(Object value) { _label = value; }protected Object _help;public Object getHelp() { return _help; }public void setHelp(Object value) { _help = value; }protected org.monet.metamodel.internal.Ref _goto;public org.monet.metamodel.internal.Ref getGoto() { return _goto; }public void setGoto(org.monet.metamodel.internal.Ref value) { _goto = value; }protected Object _history;public Object getHistory() { return _history; }public void setHistory(Object value) { _history = value; }public static class IsDefault  {protected void copy(IsDefault instance) {}protected void merge(IsDefault child) {}}protected IsDefault _isDefault;public boolean isDefault() { return (_isDefault != null); }public IsDefault getIsDefault() { return _isDefault; }public void setIsDefault(boolean value) { if(value) _isDefault = new IsDefault(); else {_isDefault = null;}}public static class IsHidden  {protected void copy(IsHidden instance) {}protected void merge(IsHidden child) {}}protected IsHidden _isHidden;public boolean isHidden() { return (_isHidden != null); }public IsHidden getIsHidden() { return _isHidden; }public void setIsHidden(boolean value) { if(value) _isHidden = new IsHidden(); else {_isHidden = null;}}protected void copy(LineStopProperty instance) {this._label = instance._label;
...
this._isHidden = instance._isHidden; 
