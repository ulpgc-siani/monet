...
public abstract class PlacePropertyBase extends ReferenceableProperty {
	...
	protected WaitActionProperty _waitActionProperty;protected SendJobActionProperty _sendJobActionProperty;protected SendRequestActionProperty _sendRequestActionProperty;protected LineActionProperty _lineActionProperty;protected EditionActionProperty _editionActionProperty;protected EnrollActionProperty _enrollActionProperty;protected SendResponseActionProperty _sendResponseActionProperty;protected DelegationActionProperty _delegationActionProperty;protected DoorActionProperty _doorActionProperty;public WaitActionProperty getWaitActionProperty() { return _waitActionProperty; }public void setWaitActionProperty(WaitActionProperty value) { if (_waitActionProperty == null) _waitActionProperty = value; else {_waitActionProperty.merge(value);} }public SendJobActionProperty getSendJobActionProperty() { return _sendJobActionProperty; }public void setSendJobActionProperty(SendJobActionProperty value) { if (_sendJobActionProperty == null) _sendJobActionProperty = value; else {_sendJobActionProperty.merge(value);} }public SendRequestActionProperty getSendRequestActionProperty() { return _sendRequestActionProperty; }public void setSendRequestActionProperty(SendRequestActionProperty value) { if (_sendRequestActionProperty == null) _sendRequestActionProperty = value; else {_sendRequestActionProperty.merge(value);} }public LineActionProperty getLineActionProperty() { return _lineActionProperty; }public void setLineActionProperty(LineActionProperty value) { if (_lineActionProperty == null) _lineActionProperty = value; else {_lineActionProperty.merge(value);} }public EditionActionProperty getEditionActionProperty() { return _editionActionProperty; }public void setEditionActionProperty(EditionActionProperty value) { if (_editionActionProperty == null) _editionActionProperty = value; else {_editionActionProperty.merge(value);} }public EnrollActionProperty getEnrollActionProperty() { return _enrollActionProperty; }public void setEnrollActionProperty(EnrollActionProperty value) { if (_enrollActionProperty == null) _enrollActionProperty = value; else {_enrollActionProperty.merge(value);} }public SendResponseActionProperty getSendResponseActionProperty() { return _sendResponseActionProperty; }public void setSendResponseActionProperty(SendResponseActionProperty value) { if (_sendResponseActionProperty == null) _sendResponseActionProperty = value; else {_sendResponseActionProperty.merge(value);} }public DelegationActionProperty getDelegationActionProperty() { return _delegationActionProperty; }public void setDelegationActionProperty(DelegationActionProperty value) { if (_delegationActionProperty == null) _delegationActionProperty = value; else {_delegationActionProperty.merge(value);} }public DoorActionProperty getDoorActionProperty() { return _doorActionProperty; }public void setDoorActionProperty(DoorActionProperty value) { if (_doorActionProperty == null) _doorActionProperty = value; else {_doorActionProperty.merge(value);} }
...
if(_backEnableProperty == null) _backEnableProperty = child._backEnableProperty; else if (child._backEnableProperty != null) {_backEnableProperty.merge(child._backEnableProperty);}
		...
		this.setWaitActionProperty(child._waitActionProperty);this.setSendJobActionProperty(child._sendJobActionProperty);this.setSendRequestActionProperty(child._sendRequestActionProperty);this.setLineActionProperty(child._lineActionProperty);this.setEditionActionProperty(child._editionActionProperty);this.setEnrollActionProperty(child._enrollActionProperty);this.setSendResponseActionProperty(child._sendResponseActionProperty);this.setDelegationActionProperty(child._delegationActionProperty);this.setDoorActionProperty(child._doorActionProperty);
	}
