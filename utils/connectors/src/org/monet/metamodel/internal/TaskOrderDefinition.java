...
public class TaskOrderDefinition extends FormDefinition {
	...
	public static final String NAME = "TaskOrderDefinition";
	...
	public TaskOrderDefinition() {
		...
		FormDefinition.FormViewProperty viewDefinition = new FormDefinition.FormViewProperty();
		viewDefinition.setCode("_vqfkjg");
		viewDefinition.setName("View");
		viewDefinition.setIsDefault(true);

		FormDefinition.FormViewProperty.ShowProperty showDefinition = new FormDefinition.FormViewProperty.ShowProperty();
		showDefinition.getField().add(new Ref("SuggestedStartDate", TaskOrderDefinition.NAME, ""));
		showDefinition.getField().add(new Ref("SuggestedEndDate", TaskOrderDefinition.NAME, ""));
		showDefinition.getField().add(new Ref("Urgent", TaskOrderDefinition.NAME, ""));
		showDefinition.getField().add(new Ref("Comments", TaskOrderDefinition.NAME, ""));
