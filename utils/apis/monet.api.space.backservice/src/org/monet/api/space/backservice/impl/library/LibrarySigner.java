...
import org.monet.api.space.backservice.impl.model.ExternalSignatureCMSSignedDataGenerator;
import org.monet.api.space.backservice.impl.model.ExternalSignatureSignerInfoGenerator;
...
public class LibrarySigner {
    ...
    public static String signText(String text, InputStream keyStore, String password) throws Exception {
        byte[] data = signText(text.getBytes(), keyStore, password);
    ...
    public static String signText(String text, String keyStorePath, String password) throws Exception {
        byte[] data = signText(text.getBytes(), new FileInputStream(keyStorePath), password);
        String sData = new String(LibraryBase64.encode(data));
        return sData;
    }

    private static byte[] signText(byte[] text, InputStream keyStoreStream, String password) throws Exception {
