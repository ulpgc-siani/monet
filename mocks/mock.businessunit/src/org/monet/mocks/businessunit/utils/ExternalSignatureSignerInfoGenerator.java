...
/**
 * An <code>org.bouncycastle.asn1.cms.SignerInfo</code> generator, where encryption operations
 * are kept external.
 * <p/>
 * The class is a reimplementation of the original nested <code>org.bouncycastle.cms.CMSSignedDataGenerator$SignerInf</code>
 * class.<br>
 * The key methods are {@link #getBytesToSign(org.bouncycastle.asn1.DERObjectIdentifier, org.bouncycastle.cms.CMSProcessable, String)}, which
 ...
 * {@link it.trento.comune.j4sign.cms.ExternalSignatureCMSSignedDataGenerator#generate(org.bouncycastle.cms.CMSProcessable, boolean)} .
 * <p/>
 * For an usage example, see {@link it.trento.comune.j4sign.cms.ExternalSignatureCMSSignedDataGenerator} and {@link it.trento.comune.j4sign.examples.CLITest}.
 *
...
public class ExternalSignatureSignerInfoGenerator {
	...
	/**
	 * The (externally) encrypted digest of {@link #getBytesToSign(org.bouncycastle.asn1.DERObjectIdentifier, org.bouncycastle.cms.CMSProcessable, String)}.
	...
	/**
	 * The set of authenticated attributes, calculated in {@link #getBytesToSign(org.bouncycastle.asn1.DERObjectIdentifier, org.bouncycastle.cms.CMSProcessable, String)} method,<br>
