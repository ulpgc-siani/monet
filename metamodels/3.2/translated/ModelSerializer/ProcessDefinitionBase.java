...
}}protected ForProperty _forProperty;public ForProperty getFor() { return _forProperty; }public void setFor(ForProperty value) { if(_forProperty!=null) _forProperty.merge(value); else {_forProperty = value;} }public static class ShowProperty  {protected String _shortcut;public String getShortcut() { return _shortcut; }public void setShortcut(String value) { _shortcut = value; }protected ArrayList<org.monet.metamodel.internal.Ref> _shortcutDefinition = new ArrayList<org.monet.metamodel.internal.Ref>();public ArrayList<org.monet.metamodel.internal.Ref> getShortcutDefinition() { return _shortcutDefinition; }public void setShortcutDefinition(ArrayList<org.monet.metamodel.internal.Ref> value) { _shortcutDefinition = value; }protected String _shortcutView;public String getShortcutView() { return _shortcutView; }public void setShortcutView(String value) { _shortcutView = value; }protected org.monet.metamodel.internal.Ref _target;public org.monet.metamodel.internal.Ref getTarget() { return _target; }public void setTarget(org.monet.metamodel.internal.Ref value) { _target = value; }public static class OrdersProperty  {protected void copy(OrdersProperty instance) {}protected void merge(OrdersProperty child) {}}protected OrdersProperty _ordersProperty;public OrdersProperty getOrders() { return _ordersProperty; }public void setOrders(OrdersProperty value) { if(_ordersProperty!=null) _ordersProperty.merge(value); else {_ordersProperty = value;} }protected void copy(ShowProperty instance) {this._shortcut = instance._shortcut;
this._shortcutDefinition.addAll(instance._shortcutDefinition);
...
if(child._shortcutDefinition != null)this._shortcutDefinition.addAll(child._shortcutDefinition);
