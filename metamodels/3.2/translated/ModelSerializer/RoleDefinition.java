...
}}protected EnableFeedersProperty _enableFeedersProperty;public EnableFeedersProperty getEnableFeeders() { return _enableFeedersProperty; }public void setEnableFeeders(EnableFeedersProperty value) { if(_enableFeedersProperty!=null) _enableFeedersProperty.merge(value); else {_enableFeedersProperty = value;} }public static class DisableEditionProperty  {protected void copy(DisableEditionProperty instance) {}protected void merge(DisableEditionProperty child) {}}protected DisableEditionProperty _disableEditionProperty;public DisableEditionProperty getDisableEdition() { return _disableEditionProperty; }public void setDisableEdition(DisableEditionProperty value) { if(_disableEditionProperty!=null) _disableEditionProperty.merge(value); else {_disableEditionProperty = value;} }
...
this._disableEditionProperty = instance._disableEditionProperty; 
...
if(_disableEditionProperty == null) _disableEditionProperty = child._disableEditionProperty; else if (child._disableEditionProperty != null) {_disableEditionProperty.merge(child._disableEditionProperty);}
