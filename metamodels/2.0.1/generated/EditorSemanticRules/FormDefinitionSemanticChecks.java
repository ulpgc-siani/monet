...
public class FormDefinitionSemanticChecks extends NodeDefinitionSemanticChecks {

  @Override
  public boolean activateRule(Definition definition) {
    return definition instanceof FormDefinition;
  }
  public void checkNodes(Definition definition) {
      super.checkNodes(definition);
      FormDefinition metaitem = (FormDefinition) definition;
      ...
      for(TextFieldDeclaration include : metaitem.getTextFieldDeclarationList()) {
        textFieldDeclaration.check(include);
                  ...
                  FormViewDeclarationSemanticChecks formViewDeclaration = new FormViewDeclarationSemanticChecks();
      formViewDeclaration.setProblems(this.getProblems());
      formViewDeclaration.setModule(this.getModule());
      for(FormViewDeclaration include : metaitem.getFormViewDeclarationList()) {
        formViewDeclaration.check(include);
      }
        }
}
