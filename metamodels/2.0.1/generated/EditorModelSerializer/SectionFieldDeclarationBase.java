...
public  class SectionFieldDeclarationBase extends MultipleableFieldDeclaration 
 {
...
protected @Element(name="is-conditional",required=false) IsConditional _isConditional;
...
protected @Element(name="view",required=false) SectionFieldViewDeclaration _sectionFieldViewDeclaration;

public boolean isExtensible() { return (_isExtensible != null); }
public void setIsExtensible(boolean value) { if(value) _isExtensible = new IsExtensible(); else _isExtensible = null;}
public boolean isConditional() { return (_isConditional != null); }
public void setIsConditional(boolean value) { if(value) _isConditional = new IsConditional(); else _isConditional = null;}
...
public SectionFieldViewDeclaration getSectionFieldViewDeclaration() { return _sectionFieldViewDeclaration; }
