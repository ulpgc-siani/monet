...
public class FormDefinitionSyncDDBB extends NodeDefinitionSyncDDBB {
  ...
  public void sync(Definition definition) throws Exception {
      ...
      for(TextFieldDeclaration include : metaitem.getTextFieldDeclarationList()) {
        textFieldDeclaration.sync(include);
                  ...
                  FormViewDeclarationSyncDDBB formViewDeclaration = new FormViewDeclarationSyncDDBB();
      formViewDeclaration.setModule(this.getModule());
      for(FormViewDeclaration include : metaitem.getFormViewDeclarationList()) {
        formViewDeclaration.sync(include);
      }
        }
}
