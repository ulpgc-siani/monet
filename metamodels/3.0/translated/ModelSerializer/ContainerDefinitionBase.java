...
}}protected LinksOutProperty _linksOutProperty;public LinksOutProperty getLinksOut() { return _linksOutProperty; }public void setLinksOut(LinksOutProperty value) { if(_linksOutProperty!=null) _linksOutProperty.merge(value); else {_linksOutProperty = value;} }public static class TasksProperty  {protected void copy(TasksProperty instance) {}protected void merge(TasksProperty child) {}}protected TasksProperty _tasksProperty;public TasksProperty getTasks() { return _tasksProperty; }public void setTasks(TasksProperty value) { if(_tasksProperty!=null) _tasksProperty.merge(value); else {_tasksProperty = value;} }public static class RevisionsProperty  {protected void copy(RevisionsProperty instance) {}protected void merge(RevisionsProperty child) {}}protected RevisionsProperty _revisionsProperty;public RevisionsProperty getRevisions() { return _revisionsProperty; }public void setRevisions(RevisionsProperty value) { if(_revisionsProperty!=null) _revisionsProperty.merge(value); else {_revisionsProperty = value;} }public static class NotesProperty  {protected void copy(NotesProperty instance) {}protected void merge(NotesProperty child) {}}protected NotesProperty _notesProperty;public NotesProperty getNotes() { return _notesProperty; }public void setNotes(NotesProperty value) { if(_notesProperty!=null) _notesProperty.merge(value); else {_notesProperty = value;} }protected void copy(ShowProperty instance) {this._component.addAll(instance._component);
