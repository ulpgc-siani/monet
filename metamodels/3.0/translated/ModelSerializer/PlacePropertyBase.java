...
if(_backEnableProperty == null) _backEnableProperty = child._backEnableProperty; else if (child._backEnableProperty != null) {_backEnableProperty.merge(child._backEnableProperty);}
		...
		this.setSendRequestActionProperty(child._sendRequestActionProperty);this.setSendJobActionProperty(child._sendJobActionProperty);this.setSendResponseActionProperty(child._sendResponseActionProperty);this.setEnrollActionProperty(child._enrollActionProperty);this.setDoorActionProperty(child._doorActionProperty);this.setDelegationActionProperty(child._delegationActionProperty);this.setEditionActionProperty(child._editionActionProperty);this.setWaitActionProperty(child._waitActionProperty);this.setLineActionProperty(child._lineActionProperty);
	}
