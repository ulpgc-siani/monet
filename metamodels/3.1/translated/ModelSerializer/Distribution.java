...
}}protected TabRolesProperty _tabRolesProperty;public TabRolesProperty getTabRoles() { return _tabRolesProperty; }public void setTabRoles(TabRolesProperty value) { if(_tabRolesProperty!=null) _tabRolesProperty.merge(value); else {_tabRolesProperty = value;} }public static class TabTasktrayProperty  {protected ArrayList<org.monet.metamodel.internal.Ref> _for = new ArrayList<org.monet.metamodel.internal.Ref>();public ArrayList<org.monet.metamodel.internal.Ref> getFor() { return _for; }public void setFor(ArrayList<org.monet.metamodel.internal.Ref> value) { _for = value; }protected void copy(TabTasktrayProperty instance) {this._for.addAll(instance._for);
}protected void merge(TabTasktrayProperty child) {if(child._for != null)this._for.addAll(child._for);
}}protected TabTasktrayProperty _tabTasktrayProperty;public TabTasktrayProperty getTabTasktray() { return _tabTasktrayProperty; }public void setTabTasktray(TabTasktrayProperty value) { if(_tabTasktrayProperty!=null) _tabTasktrayProperty.merge(value); else {_tabTasktrayProperty = value;} }public static class TabTaskboardProperty  {protected ArrayList<org.monet.metamodel.internal.Ref> _for = new ArrayList<org.monet.metamodel.internal.Ref>();public ArrayList<org.monet.metamodel.internal.Ref> getFor() { return _for; }public void setFor(ArrayList<org.monet.metamodel.internal.Ref> value) { _for = value; }protected void copy(TabTaskboardProperty instance) {this._for.addAll(instance._for);
