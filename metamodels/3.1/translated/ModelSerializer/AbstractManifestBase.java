...
public abstract class AbstractManifestBase  {
	...
	public static class SpaceProperty  {protected String _name;public String getName() { return _name; }public void setName(String value) { _name = value; }protected java.net.URI _deployUri;public java.net.URI getDeployUri() { return _deployUri; }public void setDeployUri(java.net.URI value) { _deployUri = value; }protected void copy(SpaceProperty instance) {this._name = instance._name;
...
}}protected DefaultLocationProperty _defaultLocationProperty;public DefaultLocationProperty getDefaultLocation() { return _defaultLocationProperty; }public void setDefaultLocation(DefaultLocationProperty value) { if(_defaultLocationProperty!=null) _defaultLocationProperty.merge(value); else {_defaultLocationProperty = value;} }public static class FederationProperty  {protected Object _title;public Object getTitle() { return _title; }public void setTitle(Object value) { _title = value; }protected java.net.URI _socketUri;public java.net.URI getSocketUri() { return _socketUri; }public void setSocketUri(java.net.URI value) { _socketUri = value; }protected String _secret;public String getSecret() { return _secret; }public void setSecret(String value) { _secret = value; }protected void copy(FederationProperty instance) {this._title = instance._title;
