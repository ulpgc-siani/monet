...
public abstract class PlacePropertyBase extends ReferenceableProperty {
	...
	protected SendResponseActionProperty _sendResponseActionProperty;protected EnrollActionProperty _enrollActionProperty;protected WaitActionProperty _waitActionProperty;protected SendRequestActionProperty _sendRequestActionProperty;protected DoorActionProperty _doorActionProperty;protected EditionActionProperty _editionActionProperty;protected SendJobActionProperty _sendJobActionProperty;protected DelegationActionProperty _delegationActionProperty;protected LineActionProperty _lineActionProperty;public SendResponseActionProperty getSendResponseActionProperty() { return _sendResponseActionProperty; }public void setSendResponseActionProperty(SendResponseActionProperty value) { if (_sendResponseActionProperty == null) _sendResponseActionProperty = value; else {_sendResponseActionProperty.merge(value);} }public EnrollActionProperty getEnrollActionProperty() { return _enrollActionProperty; }public void setEnrollActionProperty(EnrollActionProperty value) { if (_enrollActionProperty == null) _enrollActionProperty = value; else {_enrollActionProperty.merge(value);} }public WaitActionProperty getWaitActionProperty() { return _waitActionProperty; }public void setWaitActionProperty(WaitActionProperty value) { if (_waitActionProperty == null) _waitActionProperty = value; else {_waitActionProperty.merge(value);} }public SendRequestActionProperty getSendRequestActionProperty() { return _sendRequestActionProperty; }public void setSendRequestActionProperty(SendRequestActionProperty value) { if (_sendRequestActionProperty == null) _sendRequestActionProperty = value; else {_sendRequestActionProperty.merge(value);} }public DoorActionProperty getDoorActionProperty() { return _doorActionProperty; }public void setDoorActionProperty(DoorActionProperty value) { if (_doorActionProperty == null) _doorActionProperty = value; else {_doorActionProperty.merge(value);} }public EditionActionProperty getEditionActionProperty() { return _editionActionProperty; }public void setEditionActionProperty(EditionActionProperty value) { if (_editionActionProperty == null) _editionActionProperty = value; else {_editionActionProperty.merge(value);} }public SendJobActionProperty getSendJobActionProperty() { return _sendJobActionProperty; }public void setSendJobActionProperty(SendJobActionProperty value) { if (_sendJobActionProperty == null) _sendJobActionProperty = value; else {_sendJobActionProperty.merge(value);} }public DelegationActionProperty getDelegationActionProperty() { return _delegationActionProperty; }public void setDelegationActionProperty(DelegationActionProperty value) { if (_delegationActionProperty == null) _delegationActionProperty = value; else {_delegationActionProperty.merge(value);} }public LineActionProperty getLineActionProperty() { return _lineActionProperty; }public void setLineActionProperty(LineActionProperty value) { if (_lineActionProperty == null) _lineActionProperty = value; else {_lineActionProperty.merge(value);} }
...
this._backEnableProperty = instance._backEnableProperty; 
		...
		this.setSendResponseActionProperty(instance._sendResponseActionProperty);this.setEnrollActionProperty(instance._enrollActionProperty);this.setWaitActionProperty(instance._waitActionProperty);this.setSendRequestActionProperty(instance._sendRequestActionProperty);this.setDoorActionProperty(instance._doorActionProperty);this.setEditionActionProperty(instance._editionActionProperty);this.setSendJobActionProperty(instance._sendJobActionProperty);this.setDelegationActionProperty(instance._delegationActionProperty);this.setLineActionProperty(instance._lineActionProperty);
	}
...
if(_backEnableProperty == null) _backEnableProperty = child._backEnableProperty; else if (child._backEnableProperty != null) {_backEnableProperty.merge(child._backEnableProperty);}
		...
		this.setSendResponseActionProperty(child._sendResponseActionProperty);this.setEnrollActionProperty(child._enrollActionProperty);this.setWaitActionProperty(child._waitActionProperty);this.setSendRequestActionProperty(child._sendRequestActionProperty);this.setDoorActionProperty(child._doorActionProperty);this.setEditionActionProperty(child._editionActionProperty);this.setSendJobActionProperty(child._sendJobActionProperty);this.setDelegationActionProperty(child._delegationActionProperty);this.setLineActionProperty(child._lineActionProperty);
	}
