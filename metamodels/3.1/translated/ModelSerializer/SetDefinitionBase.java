...
public abstract class SetDefinitionBase extends NodeDefinition {
	...
	public static class SetViewPropertyBase extends org.monet.metamodel.NodeViewProperty {public static class ShowProperty  {public static class IndexProperty  {protected org.monet.metamodel.internal.Ref _withView;public org.monet.metamodel.internal.Ref getWithView() { return _withView; }public void setWithView(org.monet.metamodel.internal.Ref value) { _withView = value; }protected org.monet.metamodel.internal.Ref _sortBy;public org.monet.metamodel.internal.Ref getSortBy() { return _sortBy; }public void setSortBy(org.monet.metamodel.internal.Ref value) { _sortBy = value; }public enum SortModeEnumeration { ASC,DESC }protected SortModeEnumeration _sortMode;public SortModeEnumeration getSortMode() { return _sortMode; }public void setSortMode(SortModeEnumeration value) { _sortMode = value; }protected void copy(IndexProperty instance) {this._withView = instance._withView;
...
}}protected IndexProperty _indexProperty;public IndexProperty getIndex() { return _indexProperty; }public void setIndex(IndexProperty value) { if(_indexProperty!=null) _indexProperty.merge(value); else {_indexProperty = value;} }public static class ItemsProperty  {protected void copy(ItemsProperty instance) {}protected void merge(ItemsProperty child) {}}protected ItemsProperty _itemsProperty;public ItemsProperty getItems() { return _itemsProperty; }public void setItems(ItemsProperty value) { if(_itemsProperty!=null) _itemsProperty.merge(value); else {_itemsProperty = value;} }public static class LocationsProperty  {protected org.monet.metamodel.internal.Ref _withView;public org.monet.metamodel.internal.Ref getWithView() { return _withView; }public void setWithView(org.monet.metamodel.internal.Ref value) { _withView = value; }protected String _center;public String getCenter() { return _center; }public void setCenter(String value) { _center = value; }protected void copy(LocationsProperty instance) {this._withView = instance._withView;
this._center = instance._center;
}protected void merge(LocationsProperty child) {if(child._withView != null)this._withView = child._withView;
...
}}protected ArrayList<FilterProperty> _filterPropertyList = new ArrayList<FilterProperty>();public ArrayList<FilterProperty> getFilterList() { return _filterPropertyList; }protected void copy(SetViewPropertyBase instance) {this._label = instance._label;
...
}protected void merge(SetViewPropertyBase child) {super.merge(child);if(_showProperty == null) _showProperty = child._showProperty; else if (child._showProperty != null) {_showProperty.merge(child._showProperty);}
