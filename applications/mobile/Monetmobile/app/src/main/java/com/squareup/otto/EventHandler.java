...
class EventHandler {
  ...
  EventHandler(Object target, Method method) {
    ...
    // Compute hash code eagerly since we know it will be used frequently and we
    // cannot estimate the runtime of the
   ...
   *           if the wrapped method throws any {@link Throwable} that is not an
   *           {@link Error} ({@code Error}s are propagated as-is).
   */
