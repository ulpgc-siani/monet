...
Item ::itemName:: = new Item(Item.PROPERTY, "::type::", "::token::");
...
@attribute
Item ::itemName:: = new Item(Item.ATTRIBUTE, "::token::", "::token::", ::required::, ::multiple::);
...
@attribute$enumItem
Item ::enumItem:: = new Item(Item.ENUMVALUE, "::token::", "::token::");
...
@property
::clazzHierarchy::
Item ::itemName:: = new Item(Item.PROPERTY, "::typeOrToken::", "::token::", ::required::, ::multiple::);
::itemName::.setDescription("::description::");
::itemName::.setHint("::hint::");
::baseType::
::attributes::
...
@property$content
Item ::contentItemName:: = new Item(Item.ATTRIBUTE, "content", "content", true, false);
...
@method
Item ::itemName:: = new Item(Item.METHOD, "::name::", "::name::", ::required::);
::itemName::.setDescription("::description::");
::itemName::.setHint("::hint::");
::parentItem::.addChild(::itemName::);
::parameters::
...
@method$parameter
Item ::itemName:: = new Item(Item.PARAMETER, "::name::", "::name::", true, false);
...
definitionItem = new Item(Item.DEFINITION, "::type::", "::token::");
