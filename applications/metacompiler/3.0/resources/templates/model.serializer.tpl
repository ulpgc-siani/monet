...
public ::abstract:: class ::className:: ::extends:: {
	...
	public void copy(::className:: instance) {
		::copyAttributes::
		::copyProperties::
		::copyIncludes::
	}
...
public static class ::propertyClassName:: ::extends:: {
  ...
  protected void copy(::propertyClassName:: instance) {
    ::copyAttributes::
    ::copyProperties::
    ::copyIncludes::
  }
...
public void ::tokenAddMethod:: {
  ...
  if (current != null) {
    if (current.getClass().isAssignableFrom(value.getClass())) {
      try {
        ::tokenClass:: instance = value.getClass().newInstance();
        instance.copy(current);
        instance.setName(value.getName());
        instance.merge(value);
        ::tokenTypeMap::.put(value.getName(), instance);
      }
...
@copyAttributeMultipleAsignation
this.::name::.addAll(instance.::name::);

@copyAttributeSimpleAsignation
this.::name:: = instance.::name::;

@copyPropertyMultipleWithNames
for(::nameType:: item : instance.::name::Map.values())
	this.add::nameMethod::(item);

@copyPropertyMultiple
::name::List.addAll(instance.::name::List);

@copyPropertySimple
this.::name:: = instance.::name::; 

@copyIncludeMultipleWithNames
for(::type:: item : instance.::typeMember::Map.values())
	this.add::type::(item);

@copyIncludeMultiple
::typeMember::List.addAll(instance.::typeMember::List);

@copyIncludeSimple
this.set::type::(instance.::typeMember::);
...
public void add::tokenType::(::tokenType:: value) {
  ...
  if (current != null) {
    if (current.getClass().isAssignableFrom(value.getClass())) {
      try {
        ::tokenType:: instance = value.getClass().newInstance();
        instance.copy(current);
        instance.setCode(value.getCode());
        instance.setName(value.getName());
        instance.merge(value);
