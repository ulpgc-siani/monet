...
public class ActionRegisterMobileDevice implements ActionAccountSocket {
	private Logger logger;
	private DataRepository dataRepository;

	@Inject
	public ActionRegisterMobileDevice(Logger logger, DataRepository dataRepository) {
		this.logger = logger;
	...
	public SocketResponseMessage execute(SocketMessageModel socketMessage) {
		...
		this.dataRepository.registerMobileDevice(userId, deviceId);
