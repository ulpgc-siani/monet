...
import org.monet.federation.accountoffice.core.logger.impl.LoggerImpl;
...
public class LoggerModule extends AbstractModule {
   ...
   static class BindLoggers implements TypeListener {
      ...
      static class AssignLoggerToField<I> implements InjectionListener<I> {
         private final org.monet.federation.accountoffice.core.logger.Logger logger;
         private final Field field;

         AssignLoggerToField(org.monet.federation.accountoffice.core.logger.Logger logger, Field field) {
            this.logger = logger;
            this.field = field;
         }
      ...
      public <I> void hear(TypeLiteral<I> injectableType, TypeEncounter<I> encounter) {
         ...
         org.monet.federation.accountoffice.core.logger.Logger logger = getCorrectLoggerForType(type);
      ...
      private static <I> void assignLoggerAfterInjection(TypeEncounter<I> encounter,
               Set<Field> loggerFields, org.monet.federation.accountoffice.core.logger.Logger logger) {
      ...
      private static boolean hasLoggerParameter(Constructor<?> constructor) {
         return filter(Sets.newHashSet(constructor.getParameterTypes()), new Predicate<Class<?>>() {
            public boolean apply(Class<?> input) {
               return input.isAssignableFrom(org.monet.federation.accountoffice.core.logger.Logger.class);
            }
         }).size() > 0;
      }
      ...
      private static Set<Field> onlyLoggerFields(Set<Field> fields) {
         return filter(fields, new Predicate<Field>() {
            public boolean apply(Field input) {
               return input.getType().isAssignableFrom(org.monet.federation.accountoffice.core.logger.Logger.class);
            }
         });
      }
   }
