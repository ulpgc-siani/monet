...
public class FederationStatus {
  ...
  @Inject
  public FederationStatus(Configuration configuration) {
    boolean start = Boolean.valueOf(configuration.getProperty(Configuration.AUTOSTART));
    if(start)
      this.setRunningDate(new Date());
    else 
