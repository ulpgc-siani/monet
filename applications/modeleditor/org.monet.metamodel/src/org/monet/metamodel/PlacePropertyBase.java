...
this._backEnableProperty = instance._backEnableProperty; 
		...
		this.setEnrollActionProperty(instance._enrollActionProperty);this.setLineActionProperty(instance._lineActionProperty);this.setDelegationActionProperty(instance._delegationActionProperty);this.setWaitActionProperty(instance._waitActionProperty);this.setDoorActionProperty(instance._doorActionProperty);this.setEditionActionProperty(instance._editionActionProperty);this.setSendRequestActionProperty(instance._sendRequestActionProperty);this.setSendJobActionProperty(instance._sendJobActionProperty);this.setSendResponseActionProperty(instance._sendResponseActionProperty);
	}
...
if(_backEnableProperty == null) _backEnableProperty = child._backEnableProperty; else if (child._backEnableProperty != null) {_backEnableProperty.merge(child._backEnableProperty);}
		...
		this.setEnrollActionProperty(child._enrollActionProperty);this.setLineActionProperty(child._lineActionProperty);this.setDelegationActionProperty(child._delegationActionProperty);this.setWaitActionProperty(child._waitActionProperty);this.setDoorActionProperty(child._doorActionProperty);this.setEditionActionProperty(child._editionActionProperty);this.setSendRequestActionProperty(child._sendRequestActionProperty);this.setSendJobActionProperty(child._sendJobActionProperty);this.setSendResponseActionProperty(child._sendResponseActionProperty);
	}
