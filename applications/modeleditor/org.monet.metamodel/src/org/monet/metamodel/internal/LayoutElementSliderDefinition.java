...
public class LayoutElementSliderDefinition extends LayoutElementDefinition {
  ...
  private @XmlAttribute(name="pages", required=false) int pages;
  private @XmlElement ArrayList<LayoutElementBoxDefinition> boxes;

  public LayoutElementSliderDefinition() {
    super();
  }
