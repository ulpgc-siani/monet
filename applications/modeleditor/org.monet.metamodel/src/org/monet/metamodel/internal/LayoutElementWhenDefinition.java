...
public class LayoutElementWhenDefinition extends LayoutElementDefinition {
  private @XmlAttribute(name="value") boolean value;
  ...
  public LayoutElementWhenDefinition() {
    super();
  }
