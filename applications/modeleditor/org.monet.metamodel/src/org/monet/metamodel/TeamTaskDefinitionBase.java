...
public abstract class TeamTaskDefinitionBase extends TaskDefinition {
...
}}protected ForProperty _forProperty;public ForProperty getFor() { return _forProperty; }public void setFor(ForProperty value) { if(_forProperty!=null) _forProperty.merge(value); else {_forProperty = value;} }public static class ShowProperty  {protected String _shortcut;public String getShortcut() { return _shortcut; }public void setShortcut(String value) { _shortcut = value; }protected org.monet.metamodel.internal.Ref _target;public org.monet.metamodel.internal.Ref getTarget() { return _target; }public void setTarget(org.monet.metamodel.internal.Ref value) { _target = value; }protected void copy(ShowProperty instance) {this._shortcut = instance._shortcut;
...
if(_showProperty == null) _showProperty = child._showProperty; else if (child._showProperty != null) {_showProperty.merge(child._showProperty);}
	...
	public void copy(TeamTaskDefinitionBase instance) {
		this._target = instance._target;
...
this._isAbstract = instance._isAbstract; 
	...
	public void merge(TeamTaskDefinitionBase child) {
		super.merge(child);
...
for(ViewProperty item : child._viewPropertyMap.values())this.addView(item);
	...
	public Class<?> getMetamodelClass() {
		return TeamTaskDefinitionBase.class;
	}
