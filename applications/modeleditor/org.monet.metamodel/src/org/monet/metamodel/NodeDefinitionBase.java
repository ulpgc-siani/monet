...
}}protected ForProperty _forProperty;public ForProperty getFor() { return _forProperty; }public void setFor(ForProperty value) { if(_forProperty!=null) _forProperty.merge(value); else {_forProperty = value;} }public static class ConfirmationProperty  {protected Object _title;public Object getTitle() { return _title; }public void setTitle(Object value) { _title = value; }protected Object _description;public Object getDescription() { return _description; }public void setDescription(Object value) { _description = value; }protected void copy(ConfirmationProperty instance) {this._title = instance._title;
this._description = instance._description;
}protected void merge(ConfirmationProperty child) {if(child._title != null)this._title = child._title;
if(child._description != null)this._description = child._description;
}}protected ConfirmationProperty _confirmationProperty;public ConfirmationProperty getConfirmation() { return _confirmationProperty; }public void setConfirmation(ConfirmationProperty value) { if(_confirmationProperty!=null) _confirmationProperty.merge(value); else {_confirmationProperty = value;} }protected void copy(OperationProperty instance) {this._label = instance._label;
this._description = instance._description;
this._code = instance._code;
this._name = instance._name;
this._forProperty = instance._forProperty; 
this._confirmationProperty = instance._confirmationProperty; 
...
if(_confirmationProperty == null) _confirmationProperty = child._confirmationProperty; else if (child._confirmationProperty != null) {_confirmationProperty.merge(child._confirmationProperty);}
