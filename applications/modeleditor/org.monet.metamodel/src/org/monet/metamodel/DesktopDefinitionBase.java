...
}}protected ForProperty _forProperty;public ForProperty getFor() { return _forProperty; }public void setFor(ForProperty value) { if(_forProperty!=null) _forProperty.merge(value); else {_forProperty = value;} }public static class ViewProperty extends org.monet.metamodel.NodeViewProperty {public static class ShowProperty  {protected ArrayList<org.monet.metamodel.internal.Ref> _link = new ArrayList<org.monet.metamodel.internal.Ref>();public ArrayList<org.monet.metamodel.internal.Ref> getLink() { return _link; }public void setLink(ArrayList<org.monet.metamodel.internal.Ref> value) { _link = value; }protected ArrayList<org.monet.metamodel.internal.Ref> _dashboard = new ArrayList<org.monet.metamodel.internal.Ref>();public ArrayList<org.monet.metamodel.internal.Ref> getDashboard() { return _dashboard; }public void setDashboard(ArrayList<org.monet.metamodel.internal.Ref> value) { _dashboard = value; }protected void copy(ShowProperty instance) {this._link.addAll(instance._link);
...
if(child._dashboard != null)this._dashboard.addAll(child._dashboard);
