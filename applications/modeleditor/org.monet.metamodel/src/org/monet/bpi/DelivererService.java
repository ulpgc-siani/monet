...
public abstract class DelivererService {
  ...
  public abstract void deliverJson(URI url, Object body) throws Exception;

  public abstract void deliverJson(URI url, Object body, Map<String, String> headers) throws Exception;
