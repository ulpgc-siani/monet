...
@view
<div class="field readonly ::code:: f::type:: ::super| *::::invisible| *::::required| *::::extended| *::::multiple| *::::tableView| tableview::::conditional| *::::extensible| *::::allowOthers| *::">
  ::label::
  <input type="hidden" name="::code::" class="data"></input>
  ::field::
</div>
...
<td>
  <div class="table_envelope">
    <ul class="table">
      <!--<li class="header"><table width="100%"><tr>::headerColumns::</tr></table></li>-->
      ::elements::
    </ul>
  </div>
</td>
...
<li class="element readonly">
  <table width="100%" height="100%">
    <tr class="reference">
      ...
      <td width="100%">
        <a class="command link" href="javascript:void(null)">
          <table width="100%">
            <tr>::columns::</tr>
          </table>
        </a>
    ...
    <tr class="box" style="display:none;">
      <td class="flag" width='26px'>
        <div>&nbsp;</div>
        <a class="command close" href="javascript:void(null)" alt="Click to open">&nbsp;</a>
      </td>
      <td width="100%">
...
@field.single
<div style='::sectionHidden|display:none;::' class="widget w::type::::memo| long::::extended| *::::conditioned| *::">
...
<img alt="Marked" title="Marked" class="checker" src="::imagesPath::theme/icons/check_disabled.gif" />

@field.boolean$unchecked
<img alt="Unmarked" title="Unmarked" class="checker" src="::imagesPath::theme/icons/uncheck_disabled.gif" />
...
@field.file
<a type="text" class="component file" alt="Download document" title="Download document" id="::id::" href="::action::">::filename::</a>

@field.file.empty
<a type="text" class="component file" id="::id::"></a>

@field.picture
<a type="text" class="picture" href="::photoLink::" title="::title::" id="::id::" rel="::lightBox::" alt="Zoom">
  <div class="pictureframe">
    <img class="thumbnail" src="::photoLink::"/>
  </div>
</a>
...
@field.link
<a type="text" class="component link command" id="::id::" name="::code::" alt="::value| Ir al elemento *" title="::value| Ir al elemento *" href="javascript:void(null)">::value::</a>
...
<img alt="Checked" title="Checked" class="checker" src="::imagesPath::theme/icons/check_disabled.gif" />

@field.check$item$unchecked
<img alt="Unchecked" title="Unchecked" class="checker" src="::imagesPath::theme/icons/uncheck_disabled.gif" />
...
<a class="command" href="javascript:void(null)" alt="::label::" style="float\:left;"><img style="border\:1px solid \#666;" src="::previewImageSource::" title="::label::"/></a>
<div class="toolbar" style="float:left;border-bottom:0px;clear:both;margin: 5px 3px 10px;padding-bottom:10px;"><a class="command" href="javascript:void(null)" style="width:60px;display:inline;text-align:center;">open</a>\&nbsp;\&nbsp;\&nbsp;<a class="command" href="javascript:void(null)" style="width:60px;display:inline;text-align:center;margin-top:-10px;">download</a></div>
  
@field.node$node.empty
<div style="color:\#666;font-style:italic;">No elements</div>
...
<div class="tabbed label"><img src="::imagesPath::s.gif" alt="::label::" class="none"/><span>::label::</span></div>

@field.summation$item.simple$label.single$expandable
<a class="tabbed label"><img src="::imagesPath::s.gif" alt="::label::"/><span>::label::</span></a>
