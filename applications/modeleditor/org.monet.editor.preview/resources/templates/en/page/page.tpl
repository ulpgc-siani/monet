        ...
        <div class="layout header x-layout-active-content" id="LayoutHeader">
          <div class="leftbox">
            <div class="logo" id="HeaderLogo">
              <div class="dialog">
                <ul>
                  <li><a href="javascript:void(null)">go to organization</a></li>
                  <li><a href="javascript:showHome()">go to home</a></li>
                </ul>
              </div>
              <table>
                <tr>
                  <td>
                    ...
                    <img class="federation image" src="::organizationLogo::" title="Organization" alt="Organization">
                  </td>
                  <td style="vertical-align:middle;">
                    <a title="go to home" href="javascript:showHome()" class="command home"></a>
                    <table>
          ...
          <div class="rightbox">
            <div class="block fright" id="ViewUser">
              <span class="view user"><a class="command text" title="go to home" href="javascript:showHome()">home</a>
              <span style="margin-left:7px;">|</span>
              <span class="text" id="Notifications"><a style="white-space:nowrap;" title="Show notifications" href="javascript:void(null)" id="NotificationsLabel">Notifications</a></span>
              <span style="margin-left:7px;margin-right:7px;">|</span>
              <span><a class="command" id="cmdSendSuggestion" title="Doubt / Suggestion" href="javascript:void(null)">Doubt / Suggestion</a></span>
              <span style="margin-left:7px;">|</span>
              <span class="text" id="Username">
                ...
                <div class="panel username active" id="UsernamePanel" style="display:none;">
                  ...
                  <a id="cmdLogout" title="logout" href="javascript:void(null)" class="command logout">logout</a>
                </div>                
              </span>
            </div>
          </div>
...
@environment
<li id="::name::"><a title="start session in ::label::" href="\#" onclick="javascript:showEnvironment('::name::');" class="command">::label::<span class="current" style="display:none;">&nbsp;(actual)</span></li>
