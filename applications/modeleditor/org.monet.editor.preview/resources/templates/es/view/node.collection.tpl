...
<script type="text/javascript">
  ...
  ::operations::
  viewToolbarButtonsList["::id::"]["PRINT"].push("<a class='command button' href='javascript:void(null)'>Descargar en PDF</a>");
  viewSidebarButtonsList["::id::"]["PRINT"].push("<a class='command button' href='javascript:void(null)'>Descargar en PDF</a>");
  viewSidebarButtonsList["::id::"]["PRINT"].push("<a class='command button' href='javascript:void(null)'>Descargar en CSV</a>");
</script>
            ...
            <tr>
              ...
              <td>
                <div class='icons attributes'>
                  <a class='attribute georef val0\#\{georeferenced\}' title='El elemento no está georeferenciado' href='javascript:void(null)'></a>
                  <a class='attribute georef val1\#\{georeferenced\}' title='El elemento está georeferenciado' href='javascript:void(null)'></a>
                  ::icon::
                </div>
              </td>
            </tr>
...
@view.locationsMap
<div class="system view">Aquí va la vista de localizaciones del elemento en el sistema</div>
