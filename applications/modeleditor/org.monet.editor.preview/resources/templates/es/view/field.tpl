  ...
  <table width="100%" height="100%">
    ...
    <tr class="box" style="display:none;">
      <td class="flag" width='26px'>
        <div>&nbsp;</div>
        <a class="command close" href="javascript:void(null)" alt="Haga click para abrir el elemento">&nbsp;</a>
      </td>
      <td width="100%">
...
<img alt="Marcado" title="Marcado" class="checker" src="::imagesPath::theme/icons/check_disabled.gif" />

@field.boolean$unchecked
<img alt="Desmarcado" title="Desmarcado" class="checker" src="::imagesPath::theme/icons/uncheck_disabled.gif" />
...
@field.file
<a type="text" class="component file" alt="Descargar documento" title="Descargar documento" id="::id::" href="::action::">::filename::</a>
...
<div class="toolbar" style="float:left;border-bottom:0px;clear:both;margin: 5px 3px 10px;padding-bottom:10px;"><a class="command" href="javascript:void(null)" style="width:60px;display:inline;text-align:center;">abrir</a>\&nbsp;\&nbsp;\&nbsp;<a class="command" href="javascript:void(null)" style="width:60px;display:inline;text-align:center;margin-top:-10px;">descargar</a></div>
