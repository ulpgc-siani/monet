...
this._name = instance._name;
	...
	public void merge(DimensionProperty child) {
		...
		if(_featuresProperty == null) _featuresProperty = child._featuresProperty; else if (child._featuresProperty != null) {_featuresProperty.merge(child._featuresProperty);}
