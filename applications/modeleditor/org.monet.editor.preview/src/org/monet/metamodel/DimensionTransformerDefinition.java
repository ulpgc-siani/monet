...
public  class DimensionTransformerDefinition extends AgentDefinition {
	...
	public void merge(DimensionTransformerDefinition child) {
		super.merge(child);
	...
	public Class<?> getMetamodelClass() {
		return DimensionTransformerDefinition.class;
	}
