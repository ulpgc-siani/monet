...
public  class ComponentBuilderDefinition extends AgentDefinition {
	...
	public void copy(ComponentBuilderDefinition instance) {
...
this._isAbstract = instance._isAbstract; 
	...
	public void merge(ComponentBuilderDefinition child) {
		super.merge(child);
	...
	public Class<?> getMetamodelClass() {
		return ComponentBuilderDefinition.class;
	}
