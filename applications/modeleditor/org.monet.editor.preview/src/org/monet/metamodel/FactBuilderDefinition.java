...
public  class FactBuilderDefinition extends AgentDefinition {
	...
	public void copy(FactBuilderDefinition instance) {
...
this._isAbstract = instance._isAbstract; 
	...
	public void merge(FactBuilderDefinition child) {
		super.merge(child);
	...
	public Class<?> getMetamodelClass() {
		return FactBuilderDefinition.class;
	}
