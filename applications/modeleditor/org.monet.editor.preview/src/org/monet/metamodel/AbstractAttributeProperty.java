...
/**
AbstractAttributeProperty
Esta propiedad se utiliza para añadir un atributo a un índice

*/

public abstract class AbstractAttributeProperty extends ReferenceableProperty {
	...
	public void merge(AbstractAttributeProperty child) {
		super.merge(child);
...
if(child._source != null)this._source = child._source;
	...
	public Class<?> getMetamodelClass() {
		return AbstractAttributeProperty.class;
	}
