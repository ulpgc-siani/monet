...
public class Term extends BaseObject {
  ...
  public String getCodeThesaurus() {
    return this.codeThesaurus;
  }

  public void setCodeThesaurus(String code) {
    this.codeThesaurus = code;
  }
