 ...
 * @generated
 */
public interface Schema extends Feature
{
  /**
   ...
   * @see #setId(String)
   * @see org.monet.editor.dsl.monetModelingLanguage.MonetModelingLanguagePackage#getSchema_Id()
   * @model
   * @generated
   */
  String getId();
  ...
  /**
   * Sets the value of the '{@link org.monet.editor.dsl.monetModelingLanguage.Schema#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  EList<SchemaFeature> getProperties();
