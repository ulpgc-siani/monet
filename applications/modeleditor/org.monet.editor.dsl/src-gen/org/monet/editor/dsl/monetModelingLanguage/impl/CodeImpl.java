...
public class CodeImpl extends MinimalEObjectImpl.Container implements Code
{
  ...
  {
    return MonetModelingLanguagePackage.Literals.CODE;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MonetModelingLanguagePackage.CODE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MonetModelingLanguagePackage.CODE__VALUE:
        return getValue();
    }
