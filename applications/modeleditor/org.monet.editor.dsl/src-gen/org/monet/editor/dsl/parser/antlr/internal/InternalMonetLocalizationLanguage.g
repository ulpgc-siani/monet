...
*/
    ...
    public InternalMonetLocalizationLanguageParser(TokenStream input, MonetLocalizationLanguageGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected MonetLocalizationLanguageGrammarAccess getGrammarAccess() {
...
(	otherlv_0='language' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getDomainModelAccess().getLanguageKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getDomainModelAccess().getCodeLanguageCodeParserRuleCall_1_0()); 
	    }
		lv_code_1_0=ruleLanguageCode		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getDomainModelAccess().getFeaturesStringResourceParserRuleCall_3_0()); 
	    }
		lv_features_3_0=ruleStringResource		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDomainModelRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getDomainModelAccess().getRightCurlyBracketKeyword_4());
    }
)
;
...
entryRuleLanguageCode returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getLanguageCodeRule()); } 
	 iv_ruleLanguageCode=ruleLanguageCode 
	 { $current=$iv_ruleLanguageCode.current.getText(); }  
	 EOF 
;

// Rule LanguageCode
ruleLanguageCode returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(    this_LOCALE_0=RULE_LOCALE    {
		$current.merge(this_LOCALE_0);
    }

    { 
    newLeafNode(this_LOCALE_0, grammarAccess.getLanguageCodeAccess().getLOCALETerminalRuleCall_0()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getLanguageCodeAccess().getDefaultKeyword_1()); 
    }
)
    ;
...
(
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getStringResourceAccess().getColonKeyword_1());
    }
(
(
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getStringResourceAccess().getSemicolonKeyword_3());
    }
)
;
