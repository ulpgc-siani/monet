...
public class ImportImpl extends MinimalEObjectImpl.Container implements Import
{
  ...
  {
    return MonetModelingLanguagePackage.Literals.IMPORT;
  }
  ...
  public void setImportedNamespace(String newImportedNamespace)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MonetModelingLanguagePackage.IMPORT__IMPORTED_NAMESPACE, oldImportedNamespace, importedNamespace));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MonetModelingLanguagePackage.IMPORT__IMPORTED_NAMESPACE:
