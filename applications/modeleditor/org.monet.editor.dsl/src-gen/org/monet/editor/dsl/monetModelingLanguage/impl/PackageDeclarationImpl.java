...
public class PackageDeclarationImpl extends MinimalEObjectImpl.Container implements PackageDeclaration
{
  ...
  {
    return MonetModelingLanguagePackage.Literals.PACKAGE_DECLARATION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MonetModelingLanguagePackage.PACKAGE_DECLARATION__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetDefinition(Definition newDefinition, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MonetModelingLanguagePackage.PACKAGE_DECLARATION__DEFINITION, oldDefinition, newDefinition);
  ...
  public void setDefinition(Definition newDefinition)
  {
    if (newDefinition != definition)
    {
      ...
      if (definition != null)
        msgs = ((InternalEObject)definition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MonetModelingLanguagePackage.PACKAGE_DECLARATION__DEFINITION, null, msgs);
      if (newDefinition != null)
        msgs = ((InternalEObject)newDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MonetModelingLanguagePackage.PACKAGE_DECLARATION__DEFINITION, null, msgs);
      msgs = basicSetDefinition(newDefinition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MonetModelingLanguagePackage.PACKAGE_DECLARATION__DEFINITION, newDefinition, newDefinition));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MonetModelingLanguagePackage.PACKAGE_DECLARATION__DEFINITION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MonetModelingLanguagePackage.PACKAGE_DECLARATION__NAME:
        return getName();
      case MonetModelingLanguagePackage.PACKAGE_DECLARATION__DEFINITION:
