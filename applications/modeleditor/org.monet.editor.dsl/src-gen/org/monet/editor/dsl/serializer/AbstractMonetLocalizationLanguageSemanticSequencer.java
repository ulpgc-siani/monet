...
public abstract class AbstractMonetLocalizationLanguageSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private MonetLocalizationLanguageGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == MonetLocalizationLanguagePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case MonetLocalizationLanguagePackage.DOMAIN_MODEL:
				if(context == grammarAccess.getDomainModelRule()) {
					sequence_DomainModel(context, (DomainModel) semanticObject); 
					return; 
				}
				else break;
			case MonetLocalizationLanguagePackage.STRING_RESOURCE:
				if(context == grammarAccess.getStringResourceRule()) {
	...
	/**
	 * Constraint:
	 *     (code=LanguageCode features+=StringResource+)
	 */
	...
	protected void sequence_StringResource(EObject context, StringResource semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, MonetLocalizationLanguagePackage.Literals.STRING_RESOURCE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MonetLocalizationLanguagePackage.Literals.STRING_RESOURCE__NAME));
			if(transientValues.isValueTransient(semanticObject, MonetLocalizationLanguagePackage.Literals.STRING_RESOURCE__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MonetLocalizationLanguagePackage.Literals.STRING_RESOURCE__VALUE));
		}
