...
public class SpaceSetupServiceClient {
  ...
  public static void publish(String apiUrl, IFile modelFile, String keyStorePath, String password, OutputStream consoleStream, ProgressListener listener) throws Exception {
