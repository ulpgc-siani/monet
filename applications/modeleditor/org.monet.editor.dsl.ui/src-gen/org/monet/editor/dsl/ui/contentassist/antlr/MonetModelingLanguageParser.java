...
* generated by Xtext
*/
package org.monet.editor.dsl.ui.contentassist.antlr;
...
public class MonetModelingLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.monet.editor.dsl.ui.contentassist.antlr.internal.InternalMonetModelingLanguageParser createParser() {
		org.monet.editor.dsl.ui.contentassist.antlr.internal.InternalMonetModelingLanguageParser result = new org.monet.editor.dsl.ui.contentassist.antlr.internal.InternalMonetModelingLanguageParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getManifestFeatureAccess().getAlternatives(), "rule__ManifestFeature__Alternatives");
					put(grammarAccess.getDefinitionTypeAccess().getAlternatives(), "rule__DefinitionType__Alternatives");
					put(grammarAccess.getPropertyTypesAccess().getAlternatives(), "rule__PropertyTypes__Alternatives");
					put(grammarAccess.getMethodTypesAccess().getAlternatives(), "rule__MethodTypes__Alternatives");
					put(grammarAccess.getAttributeTypesAccess().getAlternatives(), "rule__AttributeTypes__Alternatives");
					...
					put(grammarAccess.getLocalizedTextAccess().getValueAlternatives_1_0(), "rule__LocalizedText__ValueAlternatives_1_0");
					put(grammarAccess.getResourceAccess().getTypeAlternatives_0_0(), "rule__Resource__TypeAlternatives_0_0");
					put(grammarAccess.getResourceAccess().getValueAlternatives_1_0(), "rule__Resource__ValueAlternatives_1_0");
					...
					put(grammarAccess.getPropertyFeatureAccess().getAlternatives(), "rule__PropertyFeature__Alternatives");
					put(grammarAccess.getSchemaFeatureAccess().getAlternatives(), "rule__SchemaFeature__Alternatives");
					put(grammarAccess.getSchemaPropertyOfValueAccess().getAlternatives_1(), "rule__SchemaPropertyOfValue__Alternatives_1");
					...
					put(grammarAccess.getDistributionModelAccess().getGroup(), "rule__DistributionModel__Group__0");
					put(grammarAccess.getProjectModelAccess().getGroup(), "rule__ProjectModel__Group__0");
					put(grammarAccess.getDefinitionModelAccess().getGroup(), "rule__DefinitionModel__Group__0");
					...
					put(grammarAccess.getDefinitionAccess().getGroup_8(), "rule__Definition__Group_8__0");
					put(grammarAccess.getAttributeAccess().getGroup(), "rule__Attribute__Group__0");
					put(grammarAccess.getLocalizedTextAccess().getGroup(), "rule__LocalizedText__Group__0");
					...
					put(grammarAccess.getXTReferenceAccess().getGroup(), "rule__XTReference__Group__0");
					...
					put(grammarAccess.getSchemaSectionAccess().getGroup(), "rule__SchemaSection__Group__0");
					put(grammarAccess.getSchemaPropertyAccess().getGroup(), "rule__SchemaProperty__Group__0");
					put(grammarAccess.getSchemaPropertyOfValueAccess().getGroup(), "rule__SchemaPropertyOfValue__Group__0");
					...
					put(grammarAccess.getDistributionModelAccess().getNameAssignment_1(), "rule__DistributionModel__NameAssignment_1");
					put(grammarAccess.getDistributionModelAccess().getSuperTypeAssignment_3(), "rule__DistributionModel__SuperTypeAssignment_3");
					put(grammarAccess.getDistributionModelAccess().getFeaturesAssignment_5(), "rule__DistributionModel__FeaturesAssignment_5");
					put(grammarAccess.getProjectModelAccess().getNameAssignment_1(), "rule__ProjectModel__NameAssignment_1");
					put(grammarAccess.getProjectModelAccess().getFeaturesAssignment_3(), "rule__ProjectModel__FeaturesAssignment_3");
					put(grammarAccess.getDefinitionModelAccess().getElementsAssignment_0(), "rule__DefinitionModel__ElementsAssignment_0");
					put(grammarAccess.getDefinitionModelAccess().getElementsAssignment_1(), "rule__DefinitionModel__ElementsAssignment_1");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getCodeAccess().getValueAssignment_1(), "rule__Code__ValueAssignment_1");
					put(grammarAccess.getPackageDeclarationAccess().getNameAssignment_1(), "rule__PackageDeclaration__NameAssignment_1");
					put(grammarAccess.getPackageDeclarationAccess().getDefinitionAssignment_3(), "rule__PackageDeclaration__DefinitionAssignment_3");
					put(grammarAccess.getDefinitionAccess().getCodeAssignment_0(), "rule__Definition__CodeAssignment_0");
					put(grammarAccess.getDefinitionAccess().getAbstractAssignment_1(), "rule__Definition__AbstractAssignment_1");
					put(grammarAccess.getDefinitionAccess().getExtensibleAssignment_2(), "rule__Definition__ExtensibleAssignment_2");
					put(grammarAccess.getDefinitionAccess().getNameAssignment_4(), "rule__Definition__NameAssignment_4");
					put(grammarAccess.getDefinitionAccess().getDefinitionTypeAssignment_6(), "rule__Definition__DefinitionTypeAssignment_6");
					put(grammarAccess.getDefinitionAccess().getSuperTypeAssignment_7_1(), "rule__Definition__SuperTypeAssignment_7_1");
					put(grammarAccess.getDefinitionAccess().getReplaceSuperTypeAssignment_8_1(), "rule__Definition__ReplaceSuperTypeAssignment_8_1");
					put(grammarAccess.getDefinitionAccess().getFeaturesAssignment_10(), "rule__Definition__FeaturesAssignment_10");
					...
					put(grammarAccess.getLocalizedTextAccess().getValueAssignment_1(), "rule__LocalizedText__ValueAssignment_1");
					put(grammarAccess.getResourceAccess().getTypeAssignment_0(), "rule__Resource__TypeAssignment_0");
					put(grammarAccess.getResourceAccess().getValueAssignment_1(), "rule__Resource__ValueAssignment_1");
					put(grammarAccess.getStringLiteralAccess().getValueAssignment_0(), "rule__StringLiteral__ValueAssignment_0");
					put(grammarAccess.getTimeLiteralAccess().getValueAssignment_0(), "rule__TimeLiteral__ValueAssignment_0");
					put(grammarAccess.getIntLiteralAccess().getNegativeAssignment_0(), "rule__IntLiteral__NegativeAssignment_0");
					put(grammarAccess.getIntLiteralAccess().getValueAssignment_1(), "rule__IntLiteral__ValueAssignment_1");
					put(grammarAccess.getFloatLiteralAccess().getNegativeAssignment_0(), "rule__FloatLiteral__NegativeAssignment_0");
					put(grammarAccess.getFloatLiteralAccess().getValueAssignment_1(), "rule__FloatLiteral__ValueAssignment_1");
					put(grammarAccess.getDoubleLiteralAccess().getNegativeAssignment_0(), "rule__DoubleLiteral__NegativeAssignment_0");
					put(grammarAccess.getDoubleLiteralAccess().getValueAssignment_1(), "rule__DoubleLiteral__ValueAssignment_1");
					put(grammarAccess.getExpressionLiteralAccess().getValueAssignment(), "rule__ExpressionLiteral__ValueAssignment");
					put(grammarAccess.getXTReferenceAccess().getValueAssignment_1(), "rule__XTReference__ValueAssignment_1");
					put(grammarAccess.getEnumLiteralAccess().getValueAssignment_0(), "rule__EnumLiteral__ValueAssignment_0");
					put(grammarAccess.getPropertyAccess().getCodeAssignment_0(), "rule__Property__CodeAssignment_0");
					put(grammarAccess.getPropertyAccess().getIdAssignment_1(), "rule__Property__IdAssignment_1");
					put(grammarAccess.getPropertyAccess().getNameAssignment_2(), "rule__Property__NameAssignment_2");
					put(grammarAccess.getPropertyAccess().getFeaturesAssignment_3_0_1(), "rule__Property__FeaturesAssignment_3_0_1");
					put(grammarAccess.getMethodAccess().getIdAssignment_0(), "rule__Method__IdAssignment_0");
					...
					put(grammarAccess.getDefineAccess().getValueAssignment_3(), "rule__Define__ValueAssignment_3");
					put(grammarAccess.getSchemaAccess().getIdAssignment_0(), "rule__Schema__IdAssignment_0");
					put(grammarAccess.getSchemaAccess().getPropertiesAssignment_2(), "rule__Schema__PropertiesAssignment_2");
					put(grammarAccess.getSchemaSectionAccess().getManyAssignment_0(), "rule__SchemaSection__ManyAssignment_0");
					put(grammarAccess.getSchemaSectionAccess().getIdAssignment_1(), "rule__SchemaSection__IdAssignment_1");
					put(grammarAccess.getSchemaSectionAccess().getFeaturesAssignment_3(), "rule__SchemaSection__FeaturesAssignment_3");
					put(grammarAccess.getSchemaPropertyAccess().getManyAssignment_0(), "rule__SchemaProperty__ManyAssignment_0");
					put(grammarAccess.getSchemaPropertyAccess().getIdAssignment_1(), "rule__SchemaProperty__IdAssignment_1");
					put(grammarAccess.getSchemaPropertyAccess().getSourceAssignment_2(), "rule__SchemaProperty__SourceAssignment_2");
					put(grammarAccess.getSchemaPropertyOfValueAccess().getTypeAssignment_0(), "rule__SchemaPropertyOfValue__TypeAssignment_0");
					put(grammarAccess.getSchemaPropertyOfValueAccess().getBodyAssignment_1_0(), "rule__SchemaPropertyOfValue__BodyAssignment_1_0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.monet.editor.dsl.ui.contentassist.antlr.internal.InternalMonetModelingLanguageParser typedParser = (org.monet.editor.dsl.ui.contentassist.antlr.internal.InternalMonetModelingLanguageParser) parser;
