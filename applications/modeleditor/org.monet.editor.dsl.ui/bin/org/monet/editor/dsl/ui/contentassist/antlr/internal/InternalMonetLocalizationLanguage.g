...
* generated by Xtext
*/
grammar InternalMonetLocalizationLanguage;
...
// Entry rule entryRuleLanguageCode
entryRuleLanguageCode 
:
{ before(grammarAccess.getLanguageCodeRule()); }
	 ruleLanguageCode
{ after(grammarAccess.getLanguageCodeRule()); } 
	 EOF 
;
...
ruleLanguageCode
	...
	:
(
{ before(grammarAccess.getLanguageCodeAccess().getAlternatives()); }
(rule__LanguageCode__Alternatives)
{ after(grammarAccess.getLanguageCodeAccess().getAlternatives()); }
)
...
:
(
{ before(grammarAccess.getLanguageCodeAccess().getLOCALETerminalRuleCall_0()); }
	RULE_LOCALE
{ after(grammarAccess.getLanguageCodeAccess().getLOCALETerminalRuleCall_0()); }
)

    |(
{ before(grammarAccess.getLanguageCodeAccess().getDefaultKeyword_1()); }

	'default' 

{ after(grammarAccess.getLanguageCodeAccess().getDefaultKeyword_1()); }
)
...
:
(
{ before(grammarAccess.getDomainModelAccess().getLanguageKeyword_0()); }

	'language' 

{ after(grammarAccess.getDomainModelAccess().getLanguageKeyword_0()); }
)
...
:
(
{ before(grammarAccess.getDomainModelAccess().getCodeAssignment_1()); }
(rule__DomainModel__CodeAssignment_1)
{ after(grammarAccess.getDomainModelAccess().getCodeAssignment_1()); }
)
...
(
(
{ before(grammarAccess.getDomainModelAccess().getFeaturesAssignment_3()); }
(rule__DomainModel__FeaturesAssignment_3)
{ after(grammarAccess.getDomainModelAccess().getFeaturesAssignment_3()); }
)
(
{ before(grammarAccess.getDomainModelAccess().getFeaturesAssignment_3()); }
(rule__DomainModel__FeaturesAssignment_3)*
...
:
(
{ before(grammarAccess.getDomainModelAccess().getRightCurlyBracketKeyword_4()); }

	'}' 

{ after(grammarAccess.getDomainModelAccess().getRightCurlyBracketKeyword_4()); }
)
...
:
(
{ before(grammarAccess.getStringResourceAccess().getColonKeyword_1()); }

	':' 

{ after(grammarAccess.getStringResourceAccess().getColonKeyword_1()); }
)
...
:
(
{ before(grammarAccess.getStringResourceAccess().getSemicolonKeyword_3()); }

	';' 

{ after(grammarAccess.getStringResourceAccess().getSemicolonKeyword_3()); }
)
...
:
(
{ before(grammarAccess.getDomainModelAccess().getCodeLanguageCodeParserRuleCall_1_0()); }
	ruleLanguageCode{ after(grammarAccess.getDomainModelAccess().getCodeLanguageCodeParserRuleCall_1_0()); }
)
...
:
(
{ before(grammarAccess.getDomainModelAccess().getFeaturesStringResourceParserRuleCall_3_0()); }
	ruleStringResource{ after(grammarAccess.getDomainModelAccess().getFeaturesStringResourceParserRuleCall_3_0()); }
)
