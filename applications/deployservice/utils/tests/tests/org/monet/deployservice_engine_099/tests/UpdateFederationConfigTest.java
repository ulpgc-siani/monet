...
public class UpdateFederationConfigTest extends TestCase {

	private static String Domain = "127.0.0.1";
	private static String Port = "4343";
	private static String Command = "<command id=\"update_federation_config\"><parameter id=\"user\">admin</parameter><parameter id=\"password\">1234</parameter><parameter id=\"server\">bbd5662636ef98e2ee004e114780a741</parameter><parameter id=\"container\">513bfd0337a95237431b25af61a42fcf</parameter><parameter id=\"federation-name\">federation</parameter><parameter id=\"federation-domain\">localhost</parameter><parameter id=\"federation-port\">8080</parameter></command>";
	...
	public void testUpdateFederationConfigTest() throws UnsupportedEncodingException {
//		SendTCP();
		SendHTTPS();		
	}
