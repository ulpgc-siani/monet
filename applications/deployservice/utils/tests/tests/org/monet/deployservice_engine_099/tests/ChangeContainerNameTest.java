...
public class ChangeContainerNameTest  extends TestCase {

	private static String Domain = "127.0.0.1";
	private static String Port = "4322";
	private static String Command = "<command id=\"change_container_name\"><parameter id=\"user\">admin</parameter><parameter id=\"password\">1234</parameter><parameter id=\"server\">bbd5662636ef98e2ee004e114780a741</parameter><parameter id=\"container\">fb876d6844ef4d7aca281f88b93b786b</parameter><parameter id=\"newname\">Container 1</parameter></command>";
	...
	public void testChangeContainerIDTest() {
		SendTCP();
	}

	public void main() {
		System.out.println("ChangeContainerID Test");
		testChangeContainerIDTest();
	}
