...
public class ResetLocalContainerTest extends TestCase {

	private static String Domain = "127.0.0.1";
	private static String Port = "4323";
	private static String Command = "<command id=\"reset_local_container\"><parameter id=\"user\">admin</parameter><parameter id=\"password\">1234</parameter><parameter id=\"server\">bbd5662636ef98e2ee004e114780a741</parameter><parameter id=\"container\">b85af939d9aaa3301302320e54751f00</parameter></command>";
	...
	public void testResetLocalContainerTest() {
		SendTCP();
	}

	public void main() {
		System.out.println("ResetLocalContainer Test");
		testResetLocalContainerTest();
	}
