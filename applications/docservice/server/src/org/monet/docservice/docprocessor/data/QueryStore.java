...
public interface QueryStore {
	...
	public static final String EXISTS_TEMPLATE = "Exists_Template";
	public static final String EXISTS_TEMPLATE_PARAM_ID = "id";
	...
	public static final String INSERT_TEMPLATE_DATA_PARAM_HASH = "hash";
	public static final String INSERT_TEMPLATE_DATA_PARAM_CONTENT_TYPE = "content_type";
	public static final String INSERT_TEMPLATE_DATA_PARAM_SIGNS_POSITION = "signs_position";
	...
	public static final String INSERT_DOCUMENT_PARAM_CREATED_DATE = "created_date";
	...
	public static final String SELECT_DOCUMENT_DATA_LOCATION = "Select_Document_Data_Location";
	...
	public static final String UPDATE_DOCUMENT_XML_DATA = "Update_Document_Xml_Data";
	...
	public static final String INSERT_DOCUMENT_DATA_PARAM_HASH = "hash";
	public static final String INSERT_DOCUMENT_DATA_PARAM_LOCATION = "location";

	public static final String UPDATE_DOCUMENT_DATA_LOCATION = "Update_Document_Data_Location";
	public static final String UPDATE_DOCUMENT_DATA_LOCATION_PARAM_ID_DOCUMENT = "id_document";
	public static final String UPDATE_DOCUMENT_DATA_LOCATION_PARAM_LOCATION = "location";

	public static final String EXISTS_DOCUMENT_PREVIEW = "Exists_Document_Preview";
	public static final String EXISTS_DOCUMENT_PREVIEW_PARAM_ID_DOCUMENT = "id_document";
	...
	public static final String CLEAN_DOCUMENT_PREVIEW_DATA = "Clean_Document_Preview_Data";
	public static final String CLEAN_DOCUMENT_PREVIEW_DATA_PARAM_DAYS = "days";
	...
	public static final String INSERT_DOCUMENT_PREVIEW_DATA_PARAM_CREATED_DATE = "created_date";
	...
	public static final String SELECT_TEMPLATE_DATA_FOR_DOCUMENT = "Select_Template_Data_For_Document";
	public static final String SELECT_TEMPLATE_DATA_FOR_DOCUMENT_PARAM_ID_DOCUMENT = "id_document";
	...
	public static final String SELECT_WORK_QUEUE_DOCUMENT_HAS_PENDING_OPERATIONS_OF_TYPE = "Select_Count_Work_Queue_Document_State_Of_Type";
	public static final String SELECT_WORK_QUEUE_DOCUMENT_HAS_PENDING_OPERATIONS_OF_TYPE_PARAM_ID_DOCUMENT = "id_document";
	public static final String SELECT_WORK_QUEUE_DOCUMENT_HAS_PENDING_OPERATIONS_OF_TYPE_PARAM_TYPE = "type";
	public static final String SELECT_WORK_QUEUE_DOCUMENT_HAS_PENDING_OPERATIONS_OF_TYPE_RESULTSET_COUNT = "count_state";
	...
	public static final String SELECT_TEMPLATE_SIGNS_POSITION = "Select_Template_Signs_Position";
	public static final String SELECT_TEMPLATE_SIGNS_POSITION_PARAM_ID_TEMPLATE = "id_template";
	public static final String SELECT_TEMPLATE_SIGNS_POSITION_RESULTSET_POSITION = "signs_position";
	...
	public static final String OVERWRITE_DOCUMENT_DATA = "Overwrite_Document_Data";
	public static final String OVERWRITE_DOCUMENT_PARAM_SOURCE_ID = "source_id";
	public static final String OVERWRITE_DOCUMENT_PARAM_DESTINATION_ID = "destination_id";
	...
	public static final String INFO_UPDATE_VERSION_PARAM_VALUE = "value";
