...
<div class="node partnercontext">
  <table>
    <tr><td>
		  <div class="title">Indica el proveedor para este elemento</div>
...
<div class="def configuration">
  ...
  configuration.toolbar.operationSet.push({type:"TOOL", label: "Eliminar", parameters: {command:"deleteattachment(::idNode::)"}});
  configuration.sidebar.operationSet.push({type:"TOOL", label: "Eliminar", parameters: {command:"deleteattachment(::idNode::)"}});
</div>
