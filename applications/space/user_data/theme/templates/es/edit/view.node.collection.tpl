...
<a class="command label" href="shownodechild(::idNode::,edit.html?mode=page,::previous::,::count::)"><img src='::themeSource::&path=_images/icons/previous_24.gif' alt="anterior" title="anterior"/></a>

@view.ancestor$previous.disabled
<img src='::themeSource::&path=_images/icons/previous_disabled_24.gif' alt="anterior" title="anterior"/>

@view.ancestor$next.enabled
<a class="command label" href="shownodechild(::idNode::,edit.html?mode=page,::next::,::count::)"><img src='::themeSource::&path=_images/icons/next_24.gif' alt="siguiente" title="siguiente"/></a>

@view.ancestor$next.disabled
<img src='::themeSource::&path=_images/icons/next_disabled_24.gif' alt="siguiente" title="siguiente"/>
