...
<a class="command label" href="shownodechild(::idNode::,edit.html?mode=page,::previous::,::count::)"><img src='::themeSource::&path=_images/icons/previous.png' alt="anterior" title="anterior"/></a>

@view.ancestor$previous.disabled
<img style='filter:grayscale(100%);-webkit-filter:grayscale(100%);' src='::themeSource::&path=_images/icons/previous.png' alt="anterior" title="anterior"/>

@view.ancestor$next.enabled
<a class="command label" href="shownodechild(::idNode::,edit.html?mode=page,::next::,::count::)"><img src='::themeSource::&path=_images/icons/next.png' alt="siguiente" title="siguiente"/></a>

@view.ancestor$next.disabled
<img style='filter:grayscale(100%);-webkit-filter:grayscale(100%);' src='::themeSource::&path=_images/icons/next.png' alt="siguiente" title="siguiente"/>
...
<div class="def configuration">
  ...
  configuration.toolbar.operationSet.push({type:"PRINT", label: "Descargar en PDF", parameters: {id:"::idNode::",format:"pdf",view:"::codeView::"}});
  configuration.sidebar = new Object();
  configuration.sidebar.operationSet = new Array();
  configuration.sidebar.operationSet.push({type:"PRINT", label: "Descargar en PDF", parameters: {id:"::idNode::",format:"pdf",view:"::codeView::"}});
  configuration.sidebar.operationSet.push({type:"PRINT", label: "Descargar en CSV", parameters: {id:"::idNode::",format:"csv",view:"::codeView::"}});
  configuration.sidebar.operationSet.push({type:"PRINT", label: "Descargar en Excel", parameters: {id:"::idNode::",format:"xls",view:"::codeView::"}});
...
@addList$item
Options.AddList.Items["::code::"] = {"Code": "::code::", "Label": "::label::", "Description": "::description::", "Command": "::command::"};
