...
Definition.Views["browse"]["edition"]["default"] = {Name: "preview.html?mode=page", Caption:"Normal", Hint:"Ver el elemento con la vista por defecto"};
Definition.Views["browse"]["preview"] = new Array();
Definition.Views["browse"]["preview"]["default"] = {Name: "preview.html?mode=page", Caption:"Normal", Hint:"Ver el elemento con la vista por defecto"};
