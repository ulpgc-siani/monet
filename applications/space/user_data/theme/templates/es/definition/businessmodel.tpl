...
CGBusinessModel.prototype.initDefaultDefinition = function () {
  ...
  this.aDefinitions["default"].Caption = "Tipo de nodo por defecto";
  ...
  this.aDefinitions["default"].Views["edition"]["default"] = {Name: "preview.html?mode=page", Caption:"Normal", Hint:"Ver el elemento con la vista por defecto"};
  this.aDefinitions["default"].Views["preview"] = new Array();
  this.aDefinitions["default"].Views["preview"]["default"] = {Name: "preview.html?mode=page", Caption:"Normal", Hint:"Ver el elemento con la vista por defecto"};
