...
@operation.editable
configuration.toolbar.operationSet.push({type:"EDIT", label: "Edit", parameters: {id:"::idNode::",mode:"edit.html?mode=page::from|&from=*::",index:"::index::",count:"::count::"}});
...
<a class='command' title='::label::' href='shownode(::id::)'>::shortLabel::</a>&nbsp;-&nbsp;<span title='Revisions'>Revisions</span>
...
@revision.current
<span class="revision">Current</span>
<div class="subtitle" title='::description::'>::shortDescription::</div>

@prototype
with the template <a class='command' href="shownode(::prototypeId::)" title="::prototypeLabel::">::shortPrototypeLabel::</a>
