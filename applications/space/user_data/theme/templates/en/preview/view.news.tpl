...
<li id="post_::postId::" class="postlist">
  <!--<div class="contextual">
    <ul>
      <li><a class="command" href="addfilter(post_::postId::,::postId::,MESSAGE)">Do not show this message anymore</a></li>
      <li><a class="command" href="addfilter(post_::postId::,::postId::,AUTHOR)">Do not show messages from this author anymore</a></li>
    </ul>
  </div>-->
  ...
  <div>
    ...
    <ul class="commentlist">
      ...
      <li class="newcomment disable">
        <div>
            <textarea title="Write a comment..." name="add_comment_text_text">Write a comment...</textarea>
            <a class="command button" href="addcommenttopost(::postId::)">Send</a>
        </div>
      </li>
    </ul>
  </div>
