...
@label.empty
<label>There is not any label defined</label>
...
<div id="::id::" class="widget wlist::extended| *::::conditioned| *::">
  ...
  <a class="behaviour more button" href="more()">Add</a>
</div>
    ...
    <tr>
      <td width="24px">
        <div class="elementoptions">
          <a class="move" alt="Hold on the left button of the mouse to drag an drop" title="Hold on the left button of the mouse to drag an drop"></a>
        </div>
      </td>
      <td>
        <div class="elementwidget">
          <a class="delete" alt="delete" title="delete">&nbsp;</a>
          ::fieldSingle::
        </div>
      </td>
    </tr>
  ...
  <table width="100%">
    ...
    <tr>
      <td>
        <div class="toolbar">
          <a class="behaviour more button" href="more()">Add</a>&nbsp;&nbsp;
          <a class="behaviour remove" href="remove()" style="display:none;"><img class="trigger" alt="Delete selection" title="Delete selection" src="::themeSource::&path=_images/s.gif"></img>Eliminar selección...</a>
        </div>
      </td>
    </tr>
    <tr style="display:none;"><td><div class="toolbar item"><a class="hidelist" href="javascript:void(null)">hide section</a><table class="paging"><tr><td><a class="previous" href="javascript:void(null)"></a></td><td><span class="current"></span></td><td><a class="next" href="javascript:void(null)"></a></td></tr></table></div></td></tr>
      ...
      <table width="100%" height="100%">
        <tr>
          <td class="flag">
            ...
            <a class="close" alt="Click to open the element" style="display:none;">&nbsp;</a>
          </td>
          ::templateColumns::
...
@field.boolean$label
Click to select ::declarationLabel::
...
<li class="check ancestorlevel_::ancestorLevel::::parent| parent_*:: category">
  ...
  <span style="float:left; margin-top: 2px; margin-left: 13px; display:none;">
    <a class="behaviour checkall">all</a>&nbsp;|&nbsp;
    <a class="behaviour uncheckall">none</a>
  </span>
</li>
...
<a class="button add" alt="Crear elemento" title="Create element" style="display:none;width:30px;margin-top:5px;cursor:pointer;">Create</a>
