...
@operation.editable
configuration.toolbar.operationSet.push({type:"EDIT", label: "Editing...", parameters: {id:"::idNode::",mode:"preview.html?mode=page::from|&from=*::",css:"editing",index:"::index::",count:"::count::"}});
