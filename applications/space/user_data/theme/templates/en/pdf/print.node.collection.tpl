...
@content$filter.lt
<fo:block font-size="9pt" margin-left="4mm">::label:: before than ::values::, inclusive</fo:block>

@content$filter.gt
<fo:block font-size="9pt" margin-left="4mm">::label:: after than ::values::, inclusive</fo:block>

@content$filter.condition
<fo:block font-size="9pt" margin-left="4mm">Condition\: ::value::</fo:block>
