...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
  ...
  <fo:page-sequence master-reference="page-::orientation::">
    ...
    <fo:static-content flow-name="xsl-region-after">
      <fo:block text-align="end" font-size="10pt" font-family="serif" line-height="14pt" color="\#555" border-top="0.5pt solid \#555">::label:: - Page <fo:page-number/></fo:block>
    </fo:static-content>
...
<fo:block font-size="20pt" margin-bottom="5mm" >::label::</fo:block>
<fo:block font-size="10pt" margin-bottom="6mm" color="\#666666">::date::</fo:block>
<fo:block>No tasks found</fo:block>
...
@content$header$attribute.emptyLabel
