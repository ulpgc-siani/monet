...
Lightbox.prototype = {
  ...
  initialize: function () {
    ...
    objLoadingImage.setAttribute('src', Context.Config.ImagesPath + fileLoadingImage);
    ...
    objBottomNavCloseImage.setAttribute('src', Context.Config.ImagesPath + fileBottomNavCloseImage);
  ...
  changeImage: function (imageNum) {
    ...
    imgPreloader.onload = function () {
	  ...
	  var width = imgPreloader.width > 640?640:imgPreloader.width;
	  var height = imgPreloader.height > 480?480:imgPreloader.height;
