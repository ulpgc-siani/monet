...
<table align="center" cellpadding="0" cellspacing="0" width="387px" class="DIALOG">
  <tr>
    <td width="100%" class="TITLE">Actualizando...</td>
  </tr>
  <tr>
    <td width="100%" class="BODY">
      <div class="HELP">Se está realizando una actualización del espacio de negocio. Intente acceder más tarde.</div>
      <a href="::reloadAction::">Recargar</a>
    </td>
  </tr>
  <tr height="21px">
