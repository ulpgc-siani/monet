...
public class ActionBlurNodeView extends Action {

	public ActionBlurNodeView() {
		super();
	}
	...
	public String execute() {
		...
		if (instanceId == null) {
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.BLUR_NODE_VIEW);
		}
		...
		agentPushService.pushToViewers(client, PushClient.generateViewId(Node.class, idNode), PushClientMessages.BLUR_NODE, observer);
