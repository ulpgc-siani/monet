...
public class ActionSetupTaskEnroll extends Action {
	private TaskLayer taskLayer;
	private AgentUserClient agentUserClient;

	public ActionSetupTaskEnroll() {
		super();
	...
	public String execute() {
		...
		String idContest = LibraryRequest.getParameter(Parameter.CONTEST, this.request);
		Long threadId = Thread.currentThread().getId();
		Task task;
		...
		task.getProcess().setupEnrollAction(idContest);
