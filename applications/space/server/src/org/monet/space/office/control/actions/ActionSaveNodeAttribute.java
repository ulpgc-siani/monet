...
public class ActionSaveNodeAttribute extends Action {
	private NodeLayer nodeLayer;

	public ActionSaveNodeAttribute() {
		super();
	...
	public String getUserMessage() {
		...
		return agentUserClient.getMessageForUser(threadId);
	}
	...
	public String execute() {
		...
		this.nodeLayer.saveNodeAttribute(node, data);

		jsonInfo = new JSONObject();
		jsonInfo.put("type", "node");
		jsonInfo.put("targetId", node.getId());
		jsonInfo.put("data", data);

		String message = this.getUserMessage();
		if (message != null)
			jsonInfo.put("message", message);
