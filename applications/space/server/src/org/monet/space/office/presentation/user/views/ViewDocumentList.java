...
public class ViewDocumentList extends View {

	public ViewDocumentList(Context oContext, AgentRender oAgentRender, String codeLanguage) {
	...
	public void execute(Writer writer) {
		...
		sTemplateFilename = this.getTemplateFilename(ObjectTypes.DOCUMENTLIST.toLowerCase());
		if (sTemplateFilename == null) return;

		this.context.put(Tags.DOCUMENTLIST, this.target);
