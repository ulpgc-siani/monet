...
public class ActionSaveEmbeddedNode extends Action {
	private NodeLayer nodeLayer;

	public ActionSaveEmbeddedNode() {
		super();
	...
	public String execute() {
		...
		if ((id == null) || (data == null)) {
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.SAVE_EMBEDDED_NODE);
		}
