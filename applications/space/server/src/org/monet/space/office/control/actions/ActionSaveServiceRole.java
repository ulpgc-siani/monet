...
public class ActionSaveServiceRole extends Action {
	private RoleLayer roleLayer;

	public ActionSaveServiceRole() {
		super();
	...
	public String execute() {
		...
		ServiceRole role = (ServiceRole) this.roleLayer.loadRole(id);
		Date beginDate = LibraryDate.parseDate(beginDateValue);

		role.setPartnerId(partnerId);
		role.setPartnerServiceName(partnerServiceName);
