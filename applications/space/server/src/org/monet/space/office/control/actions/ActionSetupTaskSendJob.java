...
public class ActionSetupTaskSendJob extends Action {
	private TaskLayer taskLayer;
	private NodeLayer nodeLayer;
	private AgentUserClient agentUserClient;

	public ActionSetupTaskSendJob() {
		super();
	...
	public String execute() {
		...
		if (idTask == null)
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.SETUP_TASK_SEND_JOB);
