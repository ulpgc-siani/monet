...
public class ActionSaveNodeDescriptor extends Action {
	private NodeLayer nodeLayer;

	public ActionSaveNodeDescriptor() {
		super();
	...
	public String execute() {
		...
		if ((id == null) || (data == null)) {
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.SAVE_NODE_DESCRIPTOR);
		}
		...
		this.nodeLayer.saveNodeReferenceAttributes(node, data);
