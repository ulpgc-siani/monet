...
public class ActionAddCommentToPost extends Action {
	private NewsLayer newsLayer;

	public ActionAddCommentToPost() {
		super();
	...
	public String execute() {
		...
		comment.setAuthor(user.getInfo().getFullname());
		comment.setCreateDate(new Date());
		this.newsLayer.addCommentToPost(postId, comment);

		render = this.rendersFactory.get("news", "preview.html", this.getRenderLink(), getAccount());
		render.setParameter("view", "news");
		render.setParameter("comment", comment);
