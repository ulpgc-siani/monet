...
public class ActionSaveUserRole extends Action {
	private RoleLayer roleLayer;

	public ActionSaveUserRole() {
		super();
	...
	public String execute() {
		...
		if (id == null || userId == null || beginDateValue == null) {
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.SAVE_USER_ROLE);
		}

		UserRole role = (UserRole) this.roleLayer.loadRole(id);
