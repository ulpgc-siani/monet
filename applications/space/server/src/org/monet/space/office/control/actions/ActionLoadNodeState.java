...
import org.monet.space.kernel.model.NodeState;
import org.monet.space.office.control.constants.Actions;

public class ActionLoadNodeState extends Action {
	private NodeLayer nodeLayer;

	public ActionLoadNodeState() {
		super();
	...
	public String execute() {
		...
		if (id == null)
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.LOAD_NODE_STATE);
		...
		if (nodeState == null) nodeState = new NodeState();

		return nodeState.toJson().toString();
	}
