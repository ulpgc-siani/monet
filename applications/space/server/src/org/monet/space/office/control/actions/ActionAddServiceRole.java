...
public class ActionAddServiceRole extends Action {
	private RoleLayer roleLayer;

	public ActionAddServiceRole() {
		super();
	...
	public String execute() {
		...
		FederationUnitService partnerService = partner.getServiceList().get(partnerServiceName);

		if (this.roleLayer.existsNonExpiredServiceRole(code, partner, partnerService))
			return ErrorCode.ROLE_ACTIVE;

		Role role = this.roleLayer.addServiceRole(code, partner, partnerService, beginDate, expireDate);
