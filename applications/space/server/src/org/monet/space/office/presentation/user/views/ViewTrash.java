...
public class ViewTrash extends ViewSystem {

	public ViewTrash(Context oContext, AgentRender oAgentRender, String codeLanguage) {
	...
	public void execute(Writer writer) {
		...
		this.mode = "trash" + Common.FileExtensions.HTML;
