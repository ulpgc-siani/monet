...
public class ActionSolveTaskLine extends Action {
	private TaskLayer taskLayer;

	public ActionSolveTaskLine() {
		super();
	...
	public String execute() {
		...
		String place = LibraryRequest.getParameter(Parameter.PLACE, this.request);
		String stop = LibraryRequest.getParameter(Parameter.STOP, this.request);
		Task task;
