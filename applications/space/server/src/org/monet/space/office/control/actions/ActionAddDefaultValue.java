...
public class ActionAddDefaultValue extends Action {
	private HistoryStoreLayer historyStoreLayer;

	public ActionAddDefaultValue() {
		super();
	...
	public String execute() {
		...
		if ((codeNodeType == null) || (codeProperty == null) || (sData == null)) {
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.ADD_DEFAULT_VALUE);
		}

		this.historyStoreLayer.addHistoryStoreDefaultValue(null, codeNodeType, codeProperty, sData);

		return Language.getInstance().getMessage(MessageCode.DEFAULT_VALUE_ADDED);
	}
