...
public class ActionExecuteNodeCommandOnCancel extends ActionExecuteNodeCommand {
	...
	public String execute() {
		...
		MonetEvent event = new MonetEvent(MonetEvent.NODE_EXECUTE_COMMAND_CONFIRMATION_ON_CANCEL, null, node);
		...
		return message != null ? result("message", message("failure", message)).toJSONString() : empty().toJSONString();
	}

	protected JSONObject empty() {
		return result("message", message("success", ""));
	}
