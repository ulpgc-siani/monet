...
public class ActionLoadNodeItemsLocationsCount extends ActionLocation {
	private NodeLayer nodeLayer;

	public ActionLoadNodeItemsLocationsCount() {
		super();
	...
	public String execute() {
		...
		return String.valueOf(this.nodeLayer.requestNodeListItemsLocationsCount(idNode, dataRequest));
	}
