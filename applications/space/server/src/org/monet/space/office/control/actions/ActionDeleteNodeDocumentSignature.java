...
public class ActionDeleteNodeDocumentSignature extends Action {
	NodeLayer nodeLayer;
	ComponentDocuments componentDocuments;

	public ActionDeleteNodeDocumentSignature() {
		super();
	...
	public String execute() {
		...
		String signatureId = LibraryRequest.getParameter(Parameter.SIGNATURE, this.request);
		...
		this.nodeLayer.deleteNodeDocumentSignature(node, signatureCode, signaturePosition);
