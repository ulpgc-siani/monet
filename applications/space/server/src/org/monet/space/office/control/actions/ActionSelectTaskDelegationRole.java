...
public class ActionSelectTaskDelegationRole extends Action {
	private TaskLayer taskLayer;
	private AgentUserClient agentUserClient;

	public ActionSelectTaskDelegationRole() {
		super();
	...
	public String execute() {
		...
		if (idTask == null || idRole == null)
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.SELECT_TASK_DELEGATION_ROLE);
		...
		Role role = roleLayer.loadRole(idRole);
