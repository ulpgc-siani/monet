...
public class ViewLogout extends View {
	private BusinessUnit businessUnit;

	public ViewLogout(Context oContext, AgentRender oAgentRender, String codeLanguage) {
	...
	public void execute(Writer writer) {
		...
		this.context.put(Tags.ACTION_LOGOUT, configuration.getApiUrl() + "?op=logout");

		this.agentTemplates.mergeApplicationTemplate("/office/templates/logout.tpl", this.context, writer);
	}
