...
public class ActionExistsSourceTerm extends Action {
	private SourceLayer sourceLayer;

	public ActionExistsSourceTerm() {
		super();
	...
	public String execute() {
		...
		if (code == null)
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.EXISTS_SOURCE_TERM);

		Source<SourceDefinition> source = this.sourceLayer.loadSource(idSource);
		result = this.sourceLayer.existsSourceTerm(source, code);
