...
public class ViewLoading extends View {
	...
	public ViewLoading(Context oContext, AgentRender oAgentRender, String codeLanguage) {
	...
	public void execute(Writer writer) {
		...
		this.agentTemplates.mergeApplicationTemplate("/office/templates/loading.tpl", this.context, writer);
	}
