...
public class ActionLoadLinkNodeItemsLocations extends ActionLocation {

	public ActionLoadLinkNodeItemsLocations() {
		super();
	}
	...
	public String execute() {
		...
		return printKmlLayer(this.nodeLayer.searchLinkNodeItemsLocations(dataRequest));
	}
