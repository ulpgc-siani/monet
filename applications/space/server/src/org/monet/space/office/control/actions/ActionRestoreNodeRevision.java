...
public class ActionRestoreNodeRevision extends Action {
	private NodeLayer nodeLayer;

	public ActionRestoreNodeRevision() {
		super();
	...
	public String execute() {
		...
		if (id == null || idNode == null || template == null) {
			throw new DataException(ErrorCode.INCORRECT_PARAMETERS, Actions.RESTORE_NODE_REVISION);
		}

		template = template.replace(Strings.AMPERSAND_HTML, Strings.AMPERSAND);

		this.nodeLayer.restoreNodeRevision(idNode, id);
