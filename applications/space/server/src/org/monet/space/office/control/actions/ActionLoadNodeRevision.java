...
public class ActionLoadNodeRevision extends Action {
	private NodeLayer nodeLayer;

	public ActionLoadNodeRevision() {
		super();
	...
	public String execute() {
		...
		String codeView = (String) this.request.getParameter(Parameter.VIEW);
		...
		if (id == null || idNode == null || template == null) {
		...
		node = this.nodeLayer.loadNodeRevision(idNode, id);
		...
		render.setParameter("idrevision", id);
		if (codeView != null) render.setParameter("view", codeView);
