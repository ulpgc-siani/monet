...
public class ViewsFactory {
	...
	private Boolean registerViews() {
		...
		this.register(Views.LOGOUT, ViewLogout.class);
		this.register(Views.UPDATING_SPACE, ViewUpdatingSpace.class);
		this.register(Views.APPLICATION, ViewApplication.class);
		this.register(Views.DOCUMENTLIST, ViewDocumentList.class);
		this.register(Views.HELPER, ViewHelper.class);
		this.register(Views.NODE, ViewNode.class);
		this.register(Views.TASK, ViewTask.class);
		this.register(Views.TASKLIST, ViewTaskList.class);
		this.register(Views.NOTIFICATIONLIST, ViewNotificationList.class);
		this.register(Views.TRASH, ViewTrash.class);
		this.register(Views.VIRTUALTREE, ViewTree.class);
		this.register(Views.SEARCH, ViewSearch.class);
		this.register(Views.MAIL, ViewMail.class);
	...
	public View get(String sType, AgentRender oAgentRender, String codeLanguage) {
		Class<?> cView;
		View oView = null;

		try {
			cView = (Class<?>) this.hmViews.get(sType);
			Constructor<?> oConstructor = cView.getConstructor(Context.class, AgentRender.class, String.class);
			oView = (View) oConstructor.newInstance(this.oContext, oAgentRender, codeLanguage);
