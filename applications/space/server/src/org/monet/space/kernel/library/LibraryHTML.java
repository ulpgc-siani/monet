...
public class LibraryHTML {
	...
	public static String getEntities() {
		String entities = AgentFilesystem.readFile(Resources.getFullPath("/kernel/xmlentities/xhtml-lat1.ent"));
		entities += AgentFilesystem.readFile(Resources.getFullPath("/kernel/xmlentities/xhtml-special.ent"));
		entities += AgentFilesystem.readFile(Resources.getFullPath("/kernel/xmlentities/xhtml-symbol.ent"));
		return entities;
	}
