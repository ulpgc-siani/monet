...
public abstract class Uri {
	protected @org.simpleframework.xml.Attribute(required=true) String header;
	protected @org.simpleframework.xml.Attribute(required=true) String partner;
	protected @org.simpleframework.xml.Attribute(required=true) String id;
	protected @org.simpleframework.xml.Attribute(required=false) String row = null;
