...
public class ServerConfiguration extends BaseObject {
	private String name;
	private String host;
	private String port;
	...
	public ServerConfiguration() {
		...
		this.host = new String(Strings.EMPTY);
		this.port = new String(Strings.EMPTY);
	}

	public ServerConfiguration(String name, String host, String port) {
		super();
		this.name = name;
		this.host = host;
		this.port = port;
