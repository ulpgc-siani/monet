...
public class LibraryString {
	...
	public static String cleanSpecialChars(String sData) {
		return sData != null ? LibraryString.replaceSpecialChars(sData, "") : "";
	}

    public static String cleanNonAsciiCharacters(String data) {
    ...
    public static String capitalize(String sContent) {
		...
		aChars = sContent.toLowerCase().toCharArray();
	...
	public static String shortValue(String value) {
		return LibraryString.shortValue(value, 100);
	}
	...
	public static String generateIdForKey(String key) {
		int result = 0;

		for (int i = 0; i < key.length(); i++)
			result += Integer.valueOf(key.charAt(i));
