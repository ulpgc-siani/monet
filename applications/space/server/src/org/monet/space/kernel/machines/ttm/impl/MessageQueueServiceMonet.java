			...
			if (isZIP) {
				...
				try {
					...
					for (MessageAttach attach : message.getAttachments()) {
						...
						if (attach.isDocument()) LibraryZip.addZipEntry(String.format("attach_%d" + MonetReferenceFileExtension, i), attach.getKey(), attach.getDocumentReference(), outputStream);
