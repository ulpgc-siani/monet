...
public class ComponentDocumentsMonetNoMultipleSigns extends ComponentDocuments {
	...
	public static final String NAME = "documentsmonetnomultiplesigns";
	...
	public void uploadTemplate(String idTemplate, String type, InputStream data, PositionEnumeration position, List<String> signFields) throws SystemException {
		try {
			HashMap<String, ContentBody> parameters = new HashMap<String, ContentBody>();
			String action = null;
			SignPositions documentsPosition = SignPositions.NONE;
			...
			if (position != null) {
				if (position == PositionEnumeration.BEGINNING)
					documentsPosition = SignPositions.TOP;
				else if (position == PositionEnumeration.END)
					documentsPosition = SignPositions.BOTTOM;
			}
			...
			parameters.put(REQUEST_PARAM_SIGNS_POSITION, toStringBody(documentsPosition.toString()));
	...
	public void consolidateDocument(Node node, Boolean async) throws SystemException {
		...
		try {
			HashMap<String, ContentBody> parameters = new HashMap<String, ContentBody>();
			parameters.put(REQUEST_PARAM_ACTION, toStringBody(ACTION_CONSOLIDATE_DOCUMENT));
