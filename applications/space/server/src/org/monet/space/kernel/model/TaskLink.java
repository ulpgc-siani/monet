...
public interface TaskLink {

	public TaskList loadTasks(Account account, DataRequest request);

	public Integer loadTasksCount(Account account, DataRequest request);
