...
public class ActionsFactory {
	...
	private Boolean registerActions() {
		this.register(Actions.SHOW_SERVICES, ActionShowServices.class);
		this.register(Actions.SOURCE, ActionSource.class);
		this.register(Actions.BUSINESS_SERVICE, ActionBusinessService.class);
		this.register(Actions.MAILBOX, ActionMailBox.class);
		return true;
	}
