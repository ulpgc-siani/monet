...
public class RendersFactory {
	...
	@Inject
	protected Map<String, Class<? extends Render>> rendersMap;

	public <T extends Render> T create(String renderName) {
		return (T) InjectorFactory.get().getInstance(this.rendersMap.get(renderName));
	}
