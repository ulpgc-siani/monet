...
import org.monet.space.explorer.control.dialogs.HistoryDialog;
import org.monet.space.explorer.control.displays.HistoryDisplay;
...
public class LoadHistoryAction extends Action<HistoryDialog, HistoryDisplay> {
    ...
    public void execute() throws IOException {
        ...
        display.writeList(toExplorerList(dialog.getStore().getTerms(dataRequest)));
    }
