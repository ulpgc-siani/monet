...
public class DownloadNodeFileAction extends DownloadNodeResourceAction {

    @Override
    protected byte[] getNotFoundResource() {
        return null;
    }

    @Override
    protected String getNotFoundResourceContentType() {
        return null;
    }
