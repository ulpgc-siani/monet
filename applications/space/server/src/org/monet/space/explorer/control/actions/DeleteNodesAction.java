...
import org.monet.space.explorer.control.dialogs.DeleteNodesDialog;
...
public class DeleteNodesAction extends Action<DeleteNodesDialog, HttpDisplay> {
    ...
    public void execute() throws IOException {
        ...
        for (Node node : dialog.getNodes()) {
            checkIfCanDelete(node);
    ...
    private void checkIfCanDelete(Node node) {
