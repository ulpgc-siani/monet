...
import org.monet.space.explorer.control.dialogs.LoadTaskDialog;
...
public class LoadTaskAction extends Action<LoadTaskDialog, TaskDisplay> {
    ...
    public void execute() throws IOException {
        ...
        Task task = layerProvider.getTaskLayer().loadTask(dialog.getId());
