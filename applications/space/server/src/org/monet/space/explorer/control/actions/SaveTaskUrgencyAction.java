...
import org.monet.space.explorer.control.dialogs.SaveTaskUrgencyDialog;
...
public class SaveTaskUrgencyAction extends Action<SaveTaskUrgencyDialog, Display> {
    ...
    public void execute() throws IOException {
        ...
        task.setUrgent(dialog.isUrgent());
