...
@WebServlet(name = "explorer.push", asyncSupported = true, urlPatterns = {"/servlet/explorer/push"})
public class PushController extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	private void doRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session == null) {
			response.getWriter().println(org.monet.space.explorer.model.Error.USER_NOT_LOGGED);
			return;
		}
