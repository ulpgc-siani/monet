...
package org.monet.space.setupservice;
...
public class ApplicationSetupService extends Application {
	public static final String NAME = "setupservice";

	private ApplicationSetupService() {
		super();
	}

	public synchronized static Application getInstance() {
		if (instance == null) instance = new ApplicationSetupService();
		return instance;
	}
	...
	public static String getCallbackUrl() {
		...
		return configuration.getUrl() + "?" + Parameter.OPERATION + "=" + Actions.SHOW_API;
	}
