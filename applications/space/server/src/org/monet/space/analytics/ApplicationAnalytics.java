...
package org.monet.space.analytics;

import org.monet.space.analytics.control.actions.Actions;
import org.monet.space.analytics.control.constants.Parameter;
...
public class ApplicationAnalytics extends Application {
	...
	public static final String SERVLET_NAME = "servletanalytics";
	public static final String LOG_AJAX = "analytics_ajax.log";
	...
	public synchronized static Application getInstance() {
		if (instance == null) instance = new ApplicationAnalytics();
		return instance;
	}
