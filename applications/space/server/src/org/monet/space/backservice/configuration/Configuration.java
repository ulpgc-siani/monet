...
package org.monet.space.backservice.configuration;
...
public class Configuration extends ApplicationConfiguration {
	...
	private Configuration() {
		super(ApplicationBackService.NAME);
	}
	...
	public String getUrl() {
		org.monet.space.kernel.configuration.Configuration monetConfiguration = org.monet.space.kernel.configuration.Configuration.getInstance();
		return monetConfiguration.getUrl() + Strings.BAR45 + ApplicationBackService.NAME;
	}

	public String getServletUrl() {
		org.monet.space.kernel.configuration.Configuration monetConfiguration = org.monet.space.kernel.configuration.Configuration.getInstance();
		return monetConfiguration.getServletUrl() + Strings.BAR45 + ApplicationBackService.NAME;
	}
	...
	public String getImagesPath() {
		return this.getBasePath() + "/" + ApplicationBackService.NAME + "/images";
	}

	public String getTempDir() {
		return this.getTempDir(ApplicationBackService.NAME);
	}
