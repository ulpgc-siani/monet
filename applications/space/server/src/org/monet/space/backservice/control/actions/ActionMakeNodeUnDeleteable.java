...
public class ActionMakeNodeUnDeleteable extends Action {

	public ActionMakeNodeUnDeleteable() {
	}
	...
	public String execute() {
		...
		nodeLayer.makeUndeletable(node);

		return MessageCode.NODE_MADE_UNDELETEABLE;
	}
