...
public class ActionMakeNodeDeleteable extends Action {

	public ActionMakeNodeDeleteable() {
	}
	...
	public String execute() {
		...
		nodeLayer.makeDeletable(node);

		return MessageCode.NODE_MADE_DELETEABLE;
	}
