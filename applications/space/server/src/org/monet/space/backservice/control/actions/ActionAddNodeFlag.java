...
public class ActionAddNodeFlag extends Action {

	public ActionAddNodeFlag() {
	}
	...
	public String execute() {
		...
		node.addFlag(LibraryEncoding.decode(name), LibraryEncoding.decode(value));
		nodeLayer.saveNodeFlags(node);

		return MessageCode.NODE_FLAG_ADDED;
	}
