...
public class ApplicationSetup extends Application {
	...
	public static final String SERVLET_NAME = "servletsetup";
	...
	public static String getCallbackUrl() {
		...
		return configuration.getUrl() + Actions.SHOW_APPLICATION + "&" + Parameter.ACTION + "=callback";
	}
