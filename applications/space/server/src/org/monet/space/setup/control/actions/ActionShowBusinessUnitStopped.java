...
import org.monet.space.setup.presentation.user.views.ViewError;
...
public class ActionShowBusinessUnitStopped extends Action {
	...
	public String execute() throws IOException {
		...
		ViewError viewError = (ViewError) ViewsFactory.getInstance().get(Views.ERROR, this.codeLanguage);
		viewError.setErrorCode(ErrorCode.BUSINESS_UNIT_STOPPED);
		viewError.execute(this.response.getWriter());
