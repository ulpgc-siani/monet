...
public abstract class NodeDefinition extends NodeDefinitionBase {
	...
	protected Map<String, org.monet.metamodel.RuleProperty> rulesMap = null;
	...
	protected void initRulesMap() {
		this.rulesMap = new HashMap<String, org.monet.metamodel.RuleProperty>();
	...
	public org.monet.metamodel.RuleProperty getRule(String ruleCode) {
