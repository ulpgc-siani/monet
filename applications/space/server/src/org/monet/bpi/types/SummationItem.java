...
public class SummationItem extends Observable implements Observer {
	...
	private org.monet.space.kernel.model.SummationItem value;
	...
	public SummationItem(org.monet.space.kernel.model.SummationItem value, SummationItemProperty declaration) {
		this.declaration = declaration;
		this.value = value;
		this.isCalculated = this.value.Children.size() > 0;
		for (org.monet.space.kernel.model.SummationItem child : this.value.Children) {
